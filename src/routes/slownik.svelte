  ...
  <svg
    ...
    <defs id="defs677">
      <linearGradient
        ...
        <stop id="stop669" stop-opacity="0.25" stop-color="gray" offset="0" />
        <stop
          id="stop671"
          stop-opacity="0.12"
          stop-color="gray"
          offset="0.54" />
        <stop id="stop673" stop-opacity="0.1" stop-color="gray" offset="1" />
      </linearGradient>
      <linearGradient
    ...
    <title id="title679">building_blocks</title>
    <rect
      id="rect681"
      fill="#a02828"
      ry="8.84"
