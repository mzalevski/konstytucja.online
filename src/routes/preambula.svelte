...
<div
  class="p-2 border-2 border-gray-100 border-double rounded-md md:p-8 lg:p-12">
  <div
    class="p-2 border-2 border-gray-200 border-double rounded-md md:p-8 lg:p-12 "
    in:fade={{ duration: 800 }}>
    <div
      class="p-2 border-2 border-gray-300 border-double rounded-md md:p-8 lg:p-12"
      in:fade={{ duration: 1200 }}>
      <div class="p-1" in:fly={{ y: 200, duration: 800 }}>
        <p
          class="text-center text-md sm:text-xl md:text-1xl lg:text-2xl xl:text-3xl">
          W trosce o byt i przyszłość naszej Ojczyzny,
        </p>
        <p
          class="pt-4 text-center text-md sm:text-xl md:text-1xl lg:text-2xl xl:text-3xl">
