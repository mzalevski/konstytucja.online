...
<div in:fade={{ duration: 3000 }}>
  ...
  <p class="pt-2 text-justify md:text-lg lg:text-xl">
    ...
    nowej konstytucji po 3 miesiącach od daty jej ogłoszenia, tj. 17 października
    1997 roku weszła ona w życie. Jednocześnie straciły moc obowiązujące nadal niektóre
    przepisy Konstytucji PRL z 22 lipca 1952 roku, „mała konstytucja” (Ustawa Konstytucyjna
    z 17 października 1992 roku o wzajemnych stosunkach między władzą ustawodawczą
    i wykonawczą Rzeczypospolitej Polskiej oraz o samorządzie terytorialnym) i Ustawa
    Konstytucyjna z dnia 23 kwietnia 1992 roku o trybie przygotowania i uchwalenia
  ...
  <p class="pt-2 text-justify md:text-lg lg:text-xl">
    ...
    ) zostały sprostowane w dniu 26 marca 2001 r. obwieszczeniem Prezesa Rady Ministrów:
    w
    <a
      class="underline hover:text-red-new focus:text-red-new"
      rel="prefetch"
  ...
  <p class="pt-2 text-justify md:text-lg lg:text-xl">
    ...
    Konstytucji, wprowadzającą możliwość ekstradycji obywatela polskiego na wniosek
    innego państwa lub sądowego organu międzynarodowego w związku z popełnieniem
    za granicą czynu, który stanowi przestępstwo zarówno za granicą, jak i w Polsce,
    jeżeli ekstradycję taką dopuszcza ratyfikowana umowa międzynarodowa lub ustawa
    wykonująca akt prawa stanowionego przez instytucję międzynarodową, której Polska
    jest członkiem. Nowelizacja umożliwiła dokonywanie ekstradycji między innymi
    na podstawie europejskiego nakazu aresztowania. W
    <a
      class="underline hover:text-red-new focus:text-red-new"
    ...
    wzięło udział 421 posłów, za głosowało 344, przeciw 48, wstrzymało się 29, nie
    głosowało 39 posłów. Tekst ustawy został przekazany następnie do Senatu, który
    14 września 2006 – na podstawie art. 235 ust. 2 in fine konstytucji – uchwalił
    ustawę w brzmieniu uchwalonym przez Sejm. 6 listopada 2006 Prezydent RP Lech
    Kaczyński
    <a
      class="underline hover:text-red-new focus:text-red-new"
    ...
    którą opublikowano 7 listopada 2006; zgodnie z art. 2 ustawy o zmianie Konstytucji,
    nowelizacja weszła w życie z dniem ogłoszenia.
  </p>
  ...
  <p class="pt-2 text-justify md:text-lg lg:text-xl">
    ...
    Konstytucji (dodano ust. 3), dotyczącą rozszerzenia przesłanek biernego prawa
    wyborczego. Dodany przepis art. 99 ust. 3 Konstytucji stanowi, że „wybraną do
    Sejmu lub do Senatu nie może być osoba skazana prawomocnym wyrokiem na karę pozbawienia
    wolności za przestępstwo umyślne, ścigane z oskarżenia publicznego”. W
    <a
      class="underline hover:text-red-new focus:text-red-new"
    ...
    9 lipca 2009 przez Prezydenta RP Lecha Kaczyńskiego i opublikowana 20 lipca 2009.
    Zmiana weszła w życie 21 października 2009, mając jednak zastosowanie dopiero
    począwszy od kolejnych kadencji Sejmu i Senatu (tj. od VII kadencji Sejmu i VIII
    kadencji Senatu).
  </p>
</div>
