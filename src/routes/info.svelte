...
<nav>
  <ul>
    ...
    <li>
      <a class="selected" href="info">Informacje</a>
    </li>
...
<p>
  ...
  Konstytucję, która stanowi podstawę ich republiki - państwa prawa, które staje
  w ich obronie przed arbitralną i nieograniczoną władzą.
</p>
<p class="signature">
  <a
