const articles = [
	...
	},
	{
		...
		html: `
			...
			<p>2. Naród sprawuje władzę przez swoich przedstawicieli lub bezpośrednio.</p>
		`,
		desc: ``
	},
	{
	...
	},
	{
		...
		html: `
			...
			<p>2. Rzeczpospolita Polska udziela pomocy Polakom zamieszkałym za granicą w zachowaniu ich związków z narodowym dziedzictwem kulturalnym.</p>
		`,
		desc: ``
	},
	{
	...
	},
	{
		...
		html: `
			...
			<p>2. Przepisy Konstytucji stosuje się bezpośrednio, chyba że Konstytucja stanowi inaczej.</p>
		`,
		desc: ``
	},
	{
	...
	},
	{
		...
		html: `
			...
			<p>2. Władzę ustawodawczą sprawują Sejm i Senat, władzę wykonawczą Prezydent Rzeczypospolitej Polskiej i Rada Ministrów, a władzę sądowniczą sądy i trybunały.</p>
		`,
		desc: ``
	},
	{
	...
	},
	{
		...
		html: `
			...
			<p>2. Samorząd terytorialny uczestniczy w sprawowaniu władzy publicznej. Przysługującą mu w ramach ustaw istotną część zadań publicznych samorząd wykonuje w imieniu własnym i na własną odpowiedzialność.</p>
		`,
		desc: ``
	},
	{
		...
		html: `
			...
			<p>2. W drodze ustawy można tworzyć również inne rodzaje samorządu. Samorządy te nie mogą naruszać wolności wykonywania zawodu ani ograniczać wolności podejmowania działalności gospodarczej.</p>
		`,
		desc: ``
	},
	{
	...
	},
	{
		...
		html: `
			...
			<p>2. Wywłaszczenie jest dopuszczalne jedynie wówczas, gdy jest dokonywane na cele publiczne i za słusznym odszkodowaniem.</p>
		`,
		desc: ``
	},
	{
	...
	},
	{
		...
		html: `
			...
			<p>2. Władze publiczne w Rzeczypospolitej Polskiej zachowują bezstronność w sprawach przekonań religijnych, światopoglądowych i filozoficznych, zapewniając swobodę ich wyrażania w życiu publicznym.</p>
			<p>3. Stosunki między państwem a kościołami i innymi związkami wyznaniowymi są kształtowane na zasadach poszanowania ich autonomii oraz wzajemnej niezależności każdego w swoim zakresie, jak również współdziałania dla dobra człowieka i dobra wspólnego.</p>
			<p>4. Stosunki między Rzecząpospolitą Polską a Kościołem katolickim określają umowa międzynarodowa zawarta ze Stolicą Apostolską i ustawy.</p>
			<p>5. Stosunki między Rzecząpospolitą Polską a innymi kościołami oraz związkami wyznaniowymi określają ustawy uchwalone na podstawie umów zawartych przez Radę Ministrów z ich właściwymi przedstawicielami.</p>
		`,
		desc: ``
	},
	{
		...
		html: `
			...
			<p>2. Siły Zbrojne zachowują neutralność w sprawach politycznych oraz podlegają cywilnej i demokratycznej kontroli.</p>
		`,
		desc: ``
	},
	{
	...
	},
	{
		...
		html: `
			...
			<p>2. Barwami Rzeczypospolitej Polskiej są kolory biały i czerwony.</p>
			<p>3. Hymnem Rzeczypospolitej Polskiej jest Mazurek Dąbrowskiego.</p>
			<p>4. Godło, barwy i hymn Rzeczypospolitej Polskiej podlegają ochronie prawnej.</p>
			<p>5. Szczegóły dotyczące godła, barw i hymnu określa ustawa.</p>
		`,
		desc: ``
	},
	{
	...
	},
	{
		...
		html: `
			...
			<p>2. Każdy jest obowiązany szanować wolności i prawa innych. Nikogo nie wolno zmuszać do czynienia tego, czego prawo mu nie nakazuje.</p>
	...
	},
	{
		...
		html: `
			...
			<p>2. Obywatel polski nie może utracić obywatelstwa polskiego, chyba że sam się go zrzeknie.</p>
		`,
		desc: `
	...
	},
	{
		...
		<p>Konwencja także bezwzględnie zakazuje stosowania tortur i nieludzkiego lub poniżającego traktowania albo karania, niezależnie od postępowania danych osób[6]. Użycie siły wobec drugiej osoby możliwe jest jedynie w niektórych sytuacjach o charakterze ściśle koniecznym, określonych w przepisach prawnych (np. stosowanie środków przymusu bezpośredniego wobec osób zagrażających życiu swojemu lub życiu i bezpieczeństwu innych osób). Natomiast każde użycie siły, które wykracza poza ścisłą konieczność, narusza ludzką godność i stanowi naruszenie art. 3 Konwencji[7].</p>
		...
		<p>We współczesnym orzecznictwie Trybunał określa tortury wyłącznie jako umyślne, nieludzkie traktowanie powodujące bardzo poważne i okrutne cierpienie[10]. Za nieludzkie uznaje zachowanie, jeżeli, między innymi, było ono stosowane z premedytacją przez wiele godzin i spowodowało albo faktyczne uszkodzenie ciała, albo intensywne fizyczne i psychiczne cierpienie. Natomiast traktowanie można określić jako poniżające, jeżeli miało na celu wywołanie w ofierze uczucia strachu, udręczenia i niższości będącego w stanie poniżyć i upokorzyć. Jednocześnie, Trybunał stale podkreślał, że wchodzące w grę cierpienie i poniżenie musi w każdym razie wykraczać poza nieunikniony element cierpienia lub poniżenia związany z daną formą zgodnego z prawem traktowania lub karania[11].</p>
		...
		<p>Polska ratyfikowała OPCAT w 2005 r.[13], krajowy mechanizm prewencji [tortur] (KMPT) powołany został w 2008 r. Funkcja ta powierzona została RPO[14].</p>
		<p>[1] Artykuł 5: Nikt nie może być poddany torturom albo okrutnemu, nieludzkiemu lub poniżającemu traktowaniu lub karaniu</p>
		<p>[2] Artykuł 3: (…) W tym celu są i pozostaną zakazane w stosunku do wyżej wymienionych osób w każdym czasie i w każdym miejscu: a) zamachy na życie i nietykalność cielesną w szczególności zabójstwa we wszelkiej postaci, okaleczenia, okrutne traktowanie, tortury i męki, b) branie zakładników, c) zamachy na godność osobistą, a w szczególności traktowanie poniżające i upokarzające (…)</p>
		<p>[3] Artykuł 3: Nikt nie będzie poddany torturom ani nieludzkiemu lub poniżającemu traktowaniu lub karaniu</p>
		<p>[4] Artykuł 7: Nikt nie będzie poddawany torturom albo okrutnemu, nieludzkiemu bądź poniżającemu traktowaniu lub karaniu. W szczególności nikt nie będzie poddawany, bez swej swobodnie wyrażonej zgody, doświadczeniom lekarskim lub naukowym</p>
		<p>[5] Zob. A. Ploszka, Zakaz tortur. Czy na pewno bezwzględny? [w]: Przegląd Prawniczy UW, nr I-II, rok XI, Warszawa 2012 r., str. 124</p>
		<p>[6] Zob. wyrok z dnia 24.07.2014 r w sprawie Al Nashiri przeciwko Polsce, skarga nr 28761/11, § 507 (wyrok w sprawie tajnych więzień CIA w Polsce)</p>
		<p>[7] Zob. Konwencja o Ochronie Praw człowieka i Podstawowych Wolności. Tom I. Komentarz do artykułów 1-18. L. Garlicki red., Wydawnictwo C. H. Beck, Warszawa 2010 r., str. 99.</p>
	...
	},
	{
		...
		html: `
			...
			<p>2. Każdy pozbawiony wolności nie na podstawie wyroku sądowego ma prawo odwołania się do sądu w celu niezwłocznego ustalenia legalności tego pozbawienia. O pozbawieniu wolności powiadamia się niezwłocznie rodzinę lub osobę wskazaną przez pozbawionego wolności.</p>
			<p>3. Każdy zatrzymany powinien być niezwłocznie i w sposób zrozumiały dla niego poinformowany o przyczynach zatrzymania. Powinien on być w ciągu 48 godzin od chwili zatrzymania przekazany do dyspozycji sądu. Zatrzymanego należy zwolnić, jeżeli w ciągu 24 godzin od przekazania do dyspozycji sądu nie zostanie mu doręczone postanowienie sądu o tymczasowym aresztowaniu wraz z przedstawionymi zarzutami.</p>
			<p>4. Każdy pozbawiony wolności powinien być traktowany w sposób humanitarny.</p>
			<p>5. Każdy bezprawnie pozbawiony wolności ma prawo do odszkodowania.</p>
		`,
		desc: `
	...
	},
	{
		...
		html: `
			...
			<p>2. Każdy, przeciw komu prowadzone jest postępowanie karne, ma prawo do obrony we wszystkich stadiach postępowania. Może on w szczególności wybrać obrońcę lub na zasadach określonych w ustawie korzystać z obrońcy z urzędu.</p>
	...
	},
	{
		...
		html: `
			...
			<p>2. Wyłączenie jawności rozprawy może nastąpić ze względu na moralność, bezpieczeństwo państwa i porządek publiczny oraz ze względu na ochronę życia prywatnego stron lub inny ważny interes prywatny. Wyrok ogłaszany jest publicznie.</p>
		`,
		desc: `
	...
	},
	{
		...
		html: `
			...
			<p>2. Ograniczenie lub pozbawienie praw rodzicielskich może nastąpić tylko w przypadkach określonych w ustawie i tylko na podstawie prawomocnego orzeczenia sądu.</p>
		`,
		desc: `
	...
	},
	{
		...
		html: `
			...
			<p>2. Władze publiczne nie mogą pozyskiwać, gromadzić i udostępniać innych informacji o obywatelach niż niezbędne w demokratycznym państwie prawnym.</p>
			<p>3. Każdy ma prawo dostępu do dotyczących go urzędowych dokumentów i zbiorów danych. Ograniczenie tego prawa może określić ustawa.</p>
			<p>4. Każdy ma prawo do żądania sprostowania oraz usunięcia informacji nieprawdziwych, niepełnych lub zebranych w sposób sprzeczny z ustawą.</p>
	...
	},
	{
		...
		html: `
			...
			<p>2. Każdy może swobodnie opuścić terytorium Rzeczypospolitej Polskiej.</p>
			<p>3. Wolności, o których mowa w ust. 1 i 2, mogą podlegać ograniczeniom określonym w ustawie.</p>
			<p>4. Obywatela polskiego nie można wydalić z kraju ani zakazać mu powrotu do kraju.</p>
	...
	},
	{
		...
		html: `
			...
			<p>3. Rodzice mają prawo do zapewnienia dzieciom wychowania i nauczania moralnego i religijnego zgodnie ze swoimi przekonaniami. Przepis <a class="art-scroll" rel="prefetch" href='/48'>art. 48</a> ust. 1 stosuje się odpowiednio.</p>
			...
			<p>7. Nikt nie może być obowiązany przez organy władzy publicznej do ujawnienia swojego światopoglądu, przekonań religijnych lub wyznania.</p>
		`,
		desc: `
	...
	},
	{
		...
		html: `
			...
			<p>2. Cenzura prewencyjna środków społecznego przekazu oraz koncesjonowanie prasy są zakazane. Ustawa może wprowadzić obowiązek uprzedniego uzyskania koncesji na prowadzenie stacji radiowej lub telewizyjnej.</p>
		`,
		desc: `
	...
	},
	{
		...
		html: `
			...
			<p>2. Cudzoziemcowi, który w Rzeczypospolitej Polskiej poszukuje ochrony przed prześladowaniem, może być przyznany status uchodźcy zgodnie z wiążącymi Rzeczpospolitą Polską umowami międzynarodowymi.</p>
		`,
		desc: `
	...
	},
	{
		...
		html: `
			...
			<p>2. Zakazane są zrzeszenia, których cel lub działalność są sprzeczne z Konstytucją lub ustawą. O odmowie rejestracji lub zakazie działania takiego zrzeszenia orzeka sąd.</p>
	...
	},
	{
		...
		html: `
			...
			<p>2. Związki zawodowe oraz pracodawcy i ich organizacje mają prawo do rokowań, w szczególności w celu rozwiązywania sporów zbiorowych, oraz do zawierania układów zbiorowych pracy i innych porozumień.</p>
			<p>3. Związkom zawodowym przysługuje prawo do organizowania strajków pracowniczych i innych form protestu w granicach określonych w ustawie. Ze względu na dobro publiczne ustawa może ograniczyć prowadzenie strajku lub zakazać go w odniesieniu do określonych kategorii pracowników lub w określonych dziedzinach.</p>
	...
	},
	{
		...
		html: `
			...
			<p>2. Prawo do uzyskiwania informacji obejmuje dostęp do dokumentów oraz wstęp na posiedzenia kolegialnych organów władzy publicznej pochodzących z powszechnych wyborów, z możliwością rejestracji dźwięku lub obrazu.</p>
			<p>3. Ograniczenie prawa, o którym mowa w ust. 1 i 2, może nastąpić wyłącznie ze względu na określone w ustawach ochronę wolności i praw innych osób i podmiotów gospodarczych oraz ochronę porządku publicznego, bezpieczeństwa lub ważnego interesu gospodarczego państwa.</p>
	...
	},
	{
		...
		html: `
			...
			<p>2. Prawo udziału w referendum oraz prawo wybierania nie przysługuje osobom, które prawomocnym orzeczeniem sądowym są ubezwłasnowolnione lub pozbawione praw publicznych albo wyborczych.</p>
		`,
		desc: `
	...
	},
	{
		...
		html: `
			...
			<p>2. Własność, inne prawa majątkowe oraz prawo dziedziczenia podlegają równej dla wszystkich ochronie prawnej.</p>
			<p>3. Własność może być ograniczona tylko w drodze ustawy i tylko w zakresie, w jakim nie narusza ona istoty prawa własności.</p>
		`,
		desc: `
	...
	},
	{
		...
		html: `
			...
			<p>2. Obowiązek pracy może być nałożony tylko przez ustawę.</p>
			<p>3. Stałe zatrudnianie dzieci do lat 16 jest zakazane. Formy i charakter dopuszczalnego zatrudniania określa ustawa.</p>
			<p>4. Minimalną wysokość wynagrodzenia za pracę lub sposób ustalania tej wysokości określa ustawa.</p>
	...
	},
	{
		...
		html: `
			...
			<p>2. Pracownik ma prawo do określonych w ustawie dni wolnych od pracy i corocznych płatnych urlopów; maksymalne normy czasu pracy określa ustawa.</p>
		`,
		desc: `
	...
	},
	{
		...
		html: `
			...
			<p>2. Obywatel pozostający bez pracy nie z własnej woli i nie mający innych środków utrzymania ma prawo do zabezpieczenia społecznego, którego zakres i formy określa ustawa.</p>
		`,
		desc: `
	...
	},
	{
		...
		html: `
			...
			<p>2. Obywatelom, niezależnie od ich sytuacji materialnej, władze publiczne zapewniają równy dostęp do świadczeń opieki zdrowotnej finansowanej ze środków publicznych. Warunki i zakres udzielania świadczeń określa ustawa.</p>
			<p>3. Władze publiczne są obowiązane do zapewnienia szczególnej opieki zdrowotnej dzieciom, kobietom ciężarnym, osobom niepełnosprawnym i osobom w podeszłym wieku.</p>
			<p>4. Władze publiczne są obowiązane do zwalczania chorób epidemicznych i zapobiegania negatywnym dla zdrowia skutkom degradacji środowiska.</p>
			<p>5. Władze publiczne popierają rozwój kultury fizycznej, zwłaszcza wśród dzieci i młodzieży.</p>
		`,
		desc: `
			...
			<p>2. Kolejne ustępy artykułu 68 nakładają na władze określone obowiązki:</p>
			<ul>
	...
	},
	{
		...
		html: `
			...
			<p>2. Nauka w szkołach publicznych jest bezpłatna. Ustawa może dopuścić świadczenie niektórych usług edukacyjnych przez publiczne szkoły wyższe za odpłatnością.</p>
			<p>3. Rodzice mają wolność wyboru dla swoich dzieci szkół innych niż publiczne. Obywatele i instytucje mają prawo zakładania szkół podstawowych, ponadpodstawowych i wyższych oraz zakładów wychowawczych. Warunki zakładania i działalności szkół niepublicznych oraz udziału władz publicznych w ich finansowaniu, a także zasady nadzoru pedagogicznego nad szkołami i zakładami wychowawczymi, określa ustawa.</p>
			<p>4. Władze publiczne zapewniają obywatelom powszechny i równy dostęp do wykształcenia. W tym celu tworzą i wspierają systemy indywidualnej pomocy finansowej i organizacyjnej dla uczniów i studentów. Warunki udzielania pomocy określa ustawa.</p>
	...
	},
	{
		...
		html: `
			...
			<p>2. Matka przed i po urodzeniu dziecka ma prawo do szczególnej pomocy władz publicznych, której zakres określa ustawa.</p>
		`,
		desc: `
	...
	},
	{
		...
		html: `
			...
			<p>2. Dziecko pozbawione opieki rodzicielskiej ma prawo do opieki i pomocy władz publicznych.</p>
			<p>3. W toku ustalania praw dziecka organy władzy publicznej oraz osoby odpowiedzialne za dziecko są obowiązane do wysłuchania i w miarę możliwości uwzględnienia zdania dziecka.</p>
			<p>4. Ustawa określa kompetencje i sposób powoływania Rzecznika Praw Dziecka.</p>
		`,
		desc: `
	...
	},
	{
		...
		<ul>
			...
			<li>Wolności te bezpośrednio powiązane są z wolnością wyrażania poglądów (art. 54), są szczególną forma jej realizacji. Zostały one ujęte w formę prawa podmiotowego, więc wynikają z nich roszczenia indywidualne</li>
		</ul>
		`
	},
	{
		...
		html: `
			...
			<p>4. Władze publiczne wspierają działania obywateli na rzecz ochrony i poprawy stanu środowiska.</p>
		`,
		desc: `
	...
	},
	{
		...
		html: `
			...
			<p>2. Ochronę praw lokatorów określa ustawa.</p>
		`,
		desc: `
	...
	},
	{
		...
		html: `
			...
			<p>2. Ustawa nie może nikomu zamykać drogi sądowej dochodzenia naruszonych wolności lub praw.</p>
		`,
		desc: `
	...
	},
	{
		...
		html: `
			...
			<p>2. Przepis ust. 1 nie dotyczy praw określonych w <a class="art-scroll" rel="prefetch" href='/56'>art. 56</a>.</p>
		`,
		desc: `
			...
			<p>Rzecznik korzysta z ustawowych możliwości i wspiera osoby wnoszące skargi konstytucyjne przystępując do postępowań zainicjowanych takimi skargami. W 2017 r.  Rzecznik przystąpił do 10 postępowań wszczętych przed Trybunałem Konstytucyjnym w wyniku wniesienia skargi konstytucyjnej.</p>
		`
	},
	{
		title: 'Art. 80',
	...
	},
	{
		...
		html: `
			...
			<p>2. Zakres obowiązku służby wojskowej określa ustawa.</p>
			<p>3. Obywatel, któremu przekonania religijne lub wyznawane zasady moralne nie pozwalają na odbywanie służby wojskowej, może być obowiązany do służby zastępczej na zasadach określonych w ustawie.</p>
		`,
		desc: ``
	},
	{
	...
	},
	{
		...
		html: `
			...
			<p>2. Źródłami powszechnie obowiązującego prawa Rzeczypospolitej Polskiej są na obszarze działania organów, które je ustanowiły, akty prawa miejscowego.</p>
		`,
		desc: ``
	},
	{
		...
		html: `
			...
			<p>2. Zasady i tryb ogłaszania aktów normatywnych określa ustawa.</p>
			<p>3. Umowy międzynarodowe ratyfikowane za uprzednią zgodą wyrażoną w ustawie są ogłaszane w trybie wymaganym dla ustaw. Zasady ogłaszania innych umów międzynarodowych określa ustawa.</p>
		`,
		desc: ``
	},
	{
		...
		html: `
			...
			<p>2. O zamiarze przedłożenia Prezydentowi Rzeczypospolitej do ratyfikacji umów międzynarodowych, których ratyfikacja nie wymaga zgody wyrażonej w ustawie, Prezes Rady Ministrów zawiadamia Sejm.</p>
			<p>3. Zasady oraz tryb zawierania, ratyfikowania i wypowiadania umów międzynarodowych określa ustawa.</p>
		`,
		desc: ``
	},
	{
		...
		html: `
			...
			<p>3. Wyrażenie zgody na ratyfikację takiej umowy może być uchwalone w referendum ogólnokrajowym zgodnie z przepisem <a class="art-scroll" rel="prefetch" href='/125'>art. 125</a>.</p>
	...
	},
	{
		...
		html: `
			...
			<p>2. Umowa międzynarodowa ratyfikowana za uprzednią zgodą wyrażoną w ustawie ma pierwszeństwo przed ustawą, jeżeli ustawy tej nie da się pogodzić z umową.</p>
			<p>3. Jeżeli wynika to z ratyfikowanej przez Rzeczpospolitą Polską umowy konstytuującej organizację międzynarodową, prawo przez nią stanowione jest stosowane bezpośrednio, mając pierwszeństwo w przypadku kolizji z ustawami.</p>
		`,
		desc: ``
	},
	{
		...
		html: `
			...
			<p>2. Organ upoważniony do wydania rozporządzenia nie może przekazać swoich kompetencji, o których mowa w ust. 1, innemu organowi.</p>
		`,
		desc: ``
	},
	{
		...
		html: `
			...
			<p>2. Zarządzenia są wydawane tylko na podstawie ustawy. Nie mogą one stanowić podstawy decyzji wobec obywateli, osób prawnych oraz innych podmiotów.</p>
			<p>3. Uchwały i zarządzenia podlegają kontroli co do ich zgodności z powszechnie obowiązującym prawem.</p>
		`,
		desc: ``
	},
	{
	...
	},
	{
		...
		html: `
			...
			<p>2. Sejm sprawuje kontrolę nad działalnością Rady Ministrów w zakresie określonym przepisami Konstytucji i ustaw.</p>
		`,
		desc: ``
	},
	{
		...
		html: `
			...
			<p>2. Wybory do Sejmu są powszechne, równe, bezpośrednie i proporcjonalne oraz odbywają się w głosowaniu tajnym.</p>
		`,
		desc: ``
	},
	{
		...
		html: `
			...
			<p>2. Wybory do Senatu są powszechne, bezpośrednie i odbywają się w głosowaniu tajnym.</p>
		`,
		desc: ``
	},
	{
		...
		html: `
			...
			<p>2. Wybory do Sejmu i Senatu zarządza Prezydent Rzeczypospolitej nie później niż na 90 dni przed upływem 4 lat od rozpoczęcia kadencji Sejmu i Senatu, wyznaczając wybory na dzień wolny od pracy, przypadający w ciągu 30 dni przed upływem 4 lat od rozpoczęcia kadencji Sejmu i Senatu.</p>
			<p>3. Sejm może skrócić swoją kadencję uchwałą podjętą większością co najmniej 2/3 głosów ustawowej liczby posłów. Skrócenie kadencji Sejmu oznacza jednoczesne skrócenie kadencji Senatu. Przepis ust. 5 stosuje się odpowiednio.</p>
			<p>4. Prezydent Rzeczypospolitej, po zasięgnięciu opinii Marszałka Sejmu i Marszałka Senatu, może w przypadkach określonych w Konstytucji zarządzić skrócenie kadencji Sejmu. Wraz ze skróceniem kadencji Sejmu skrócona zostaje również kadencja Senatu."</p>
			<p>5. Prezydent Rzeczypospolitej, zarządzając skrócenie kadencji Sejmu, zarządza jednocześnie wybory do Sejmu i Senatu i wyznacza ich datę na dzień przypadający nie później niż w ciągu 45 dni od dnia zarządzenia skrócenia kadencji Sejmu. Prezydent Rzeczypospolitej zwołuje pierwsze posiedzenie nowo wybranego Sejmu nie później niż na 15 dzień po dniu przeprowadzenia wyborów.</p>
			<p>6. W razie skrócenia kadencji Sejmu stosuje się odpowiednio przepis ust. 1.</p>
		`,
		desc: ``
	},
	{
		...
		html: `
			...
			<p>2. Wybrany do Senatu może być obywatel polski mający prawo wybierania, który najpóźniej w dniu wyborów kończy 30 lat.</p>
			<p>3. Wybraną do Sejmu lub do Senatu nie może być osoba skazana prawomocnym wyrokiem na karę pozbawienia wolności za przestępstwo umyślne ścigane z oskarżenia publicznego.</p>
		`,
		desc: ``
	},
	{
		...
		html: `
			...
			<p>2. Nie można kandydować równocześnie do Sejmu i Senatu.</p>
			<p>3. Zasady i tryb zgłaszania kandydatów i przeprowadzania wyborów oraz warunki ważności wyborów określa ustawa.</p>
		`,
		desc: ``
	},
	{
		...
		html: `
			...
			<p>2. Wyborcy przysługuje prawo zgłoszenia do Sądu Najwyższego protestu przeciwko ważności wyborów na zasadach określonych w ustawie.</p>
		`,
		desc: ``
	},
	{
	...
	},
	{
		...
		html: `
			...
			<p>2. Sędzia, prokurator, urzędnik służby cywilnej, żołnierz pozostający w czynnej służbie wojskowej, funkcjonariusz policji oraz funkcjonariusz służb ochrony państwa nie mogą sprawować mandatu poselskiego.</p>
			<p>3. Inne przypadki zakazu łączenia mandatu poselskiego z funkcjami publicznymi oraz zakazu jego sprawowania może określić ustawa.</p>
		`,
		desc: ``
	},
	{
	...
	},
	{
		...
		html: `
			...
			<p>2. Od dnia ogłoszenia wyników wyborów do dnia wygaśnięcia mandatu poseł nie może być pociągnięty bez zgody Sejmu do odpowiedzialności karnej.</p>
			<p>3. Postępowanie karne wszczęte wobec osoby przed dniem wyboru jej na posła ulega na żądanie Sejmu zawieszeniu do czasu wygaśnięcia mandatu. W takim przypadku ulega również zawieszeniu na ten czas bieg przedawnienia w postępowaniu karnym.</p>
			<p>4. Poseł może wyrazić zgodę na pociągnięcie go do odpowiedzialności karnej. W takim przypadku nie stosuje się przepisów ust. 2 i 3.</p>
			...
			<p>6. Szczegółowe zasady pociągania posłów do odpowiedzialności karnej oraz tryb postępowania określa ustawa.</p>
		`,
		desc: ``
	},
	{
	...
	},
	{
		...
		html: `
			...
			<p>2. Za naruszenie zakazów, o których mowa w ust. 1, poseł, uchwałą Sejmu podjętą na wniosek Marszałka Sejmu, może być pociągnięty do odpowiedzialności przed Trybunałem Stanu, który orzeka w przedmiocie pozbawienia mandatu.</p>
		`,
		desc: ``
	},
	{
	...
	},
	{
		...
		html: `
			...
			<p>2. Pierwsze posiedzenia Sejmu i Senatu Prezydent Rzeczypospolitej zwołuje na dzień przypadający w ciągu 30 dni od dnia wyborów, z wyjątkiem przypadków określonych w <a class="art-scroll" rel="prefetch" href='/98'>art. 98</a> ust. 3 i 5.</p>
		`,
		desc: ``
	},
	{
		...
		html: `
			...
			<p>2. Marszałek Sejmu przewodniczy obradom Sejmu, strzeże praw Sejmu oraz reprezentuje Sejm na zewnątrz.</p>
			<p>3. Sejm powołuje komisje stałe oraz może powoływać komisje nadzwyczajne.</p>
		`,
		desc: ``
	},
	{
		...
		html: `
			...
			<p>2. Tryb działania komisji śledczej określa ustawa.</p>
		`,
		desc: ``
	},
	{
	...
	},
	{
		...
		html: `
			...
			<p>2. Zgromadzenie Narodowe uchwala swój regulamin.</p>
		`,
		desc: ``
	},
	{
		...
		html: `
			...
			<p>2. Prezes Rady Ministrów i pozostali członkowie Rady Ministrów mają obowiązek udzielenia odpowiedzi w sprawach bieżących na każdym posiedzeniu Sejmu.</p>
		`,
		desc: ``
	},
	{
		...
		html: `
			...
			<p>2. Sejm może podjąć uchwałę o stanie wojny jedynie w razie zbrojnej napaści na terytorium Rzeczypospolitej Polskiej lub gdy z umów międzynarodowych wynika zobowiązanie do wspólnej obrony przeciwko agresji. Jeżeli Sejm nie może się zebrać na posiedzenie, o stanie wojny postanawia Prezydent Rzeczypospolitej.</p>
		`,
		desc: ``
	},
	{
	...
	},
	{
		...
		html: `
			...
			<p>2. Inicjatywa ustawodawcza przysługuje również grupie co najmniej 100 000 obywateli mających prawo wybierania do Sejmu. Tryb postępowania w tej sprawie określa ustawa.</p>
			<p>3. Wnioskodawcy przedkładając Sejmowi projekt ustawy, przedstawiają skutki finansowe jej wykonania.</p>
		`,
		desc: ``
	},
	{
		...
		html: `
			...
			<p>2. Prawo wnoszenia poprawek do projektu ustawy w czasie rozpatrywania go przez Sejm przysługuje wnioskodawcy projektu, posłom i Radzie Ministrów.</p>
			<p>3. Marszałek Sejmu może odmówić poddania pod głosowanie poprawki, która uprzednio nie była przedłożona komisji.</p>
			<p>4. Wnioskodawca może wycofać projekt ustawy w toku postępowania ustawodawczego w Sejmie do czasu zakończenia drugiego czytania projektu.</p>
		`,
		desc: ``
	},
	{
	...
	},
	{
		...
		html: `
			...
			<p>2. Senat w ciągu 30 dni od dnia przekazania ustawy może ją przyjąć bez zmian, uchwalić poprawki albo uchwalić odrzucenie jej w całości. Jeżeli Senat w ciągu 30 dni od dnia przekazania ustawy nie podejmie stosownej uchwały, ustawę uznaje się za uchwaloną w brzmieniu przyjętym przez Sejm.</p>
			<p>3. Uchwałę Senatu odrzucającą ustawę albo poprawkę zaproponowaną w uchwale Senatu, uważa się za przyjętą, jeżeli Sejm nie odrzuci jej bezwzględną większością głosów w obecności co najmniej połowy ustawowej liczby posłów.</p>
		`,
		desc: ``
	},
	{
		...
		html: `
			...
			<p>5. Jeżeli Prezydent Rzeczypospolitej nie wystąpił z wnioskiem do Trybunału Konstytucyjnego w trybie ust. 3, może z umotywowanym wnioskiem przekazać ustawę Sejmowi do ponownego rozpatrzenia. Po ponownym uchwaleniu ustawy przez Sejm większością 3/5 głosów w obecności co najmniej połowy ustawowej liczby posłów Prezydent Rzeczypospolitej w ciągu 7 dni podpisuje ustawę i zarządza jej ogłoszenie w Dzienniku Ustaw Rzeczypospolitej Polskiej. W razie ponownego uchwalenia ustawy przez Sejm Prezydentowi Rzeczypospolitej nie przysługuje prawo wystąpienia do Trybunału Konstytucyjnego w trybie ust. 3.</p>
			<p>6. Wystąpienie Prezydenta Rzeczypospolitej do Trybunału Konstytucyjnego z wnioskiem w sprawie zgodności ustawy z Konstytucją lub z wnioskiem do Sejmu o ponowne rozpatrzenie ustawy wstrzymuje bieg, określonego w ust. 2, terminu do podpisania ustawy.</p>
		`,
		desc: ``
	},
	{
		...
		html: `
			...
			<p>2. Regulamin Sejmu oraz regulamin Senatu określają odrębności w postępowaniu ustawodawczym w sprawie projektu pilnego.</p>
			<p>3. W postępowaniu w sprawie ustawy, której projekt został uznany za pilny, termin jej rozpatrzenia przez Senat wynosi 14 dni, a termin podpisania ustawy przez Prezydenta Rzeczypospolitej wynosi 7 dni.</p>
		`,
		desc: ``
	},
	{
	...
	},
	{
		...
		html: `
			...
			<p>4. Ważność referendum ogólnokrajowego oraz referendum, o którym mowa w <a class="art-scroll" rel="prefetch" href='/235'>art. 235</a> ust. 6, stwierdza Sąd Najwyższy.</p>
	...
	},
	{
		...
		html: `
			...
			<p>2. Prezydent Rzeczypospolitej czuwa nad przestrzeganiem Konstytucji, stoi na straży suwerenności i bezpieczeństwa państwa oraz nienaruszalności i niepodzielności jego terytorium.</p>
			<p>3. Prezydent Rzeczypospolitej wykonuje swoje zadania w zakresie i na zasadach określonych w Konstytucji i ustawach.</p>
		`,
		desc: ``
	},
	{
		...
		html: `
			...
			<p>2. Prezydent Rzeczypospolitej jest wybierany na pięcioletnią kadencję i może być ponownie wybrany tylko raz.</p>
			<p>3. Na Prezydenta Rzeczypospolitej może być wybrany obywatel polski, który najpóźniej w dniu wyborów kończy 35 lat i korzysta z pełni praw wyborczych do Sejmu. Kandydata zgłasza co najmniej 100 000 obywateli mających prawo wybierania do Sejmu.</p>
			<p>4. Na Prezydenta Rzeczypospolitej wybrany zostaje kandydat, który otrzymał więcej niż połowę ważnie oddanych głosów. Jeżeli żaden z kandydatów nie uzyska wymaganej większości, czternastego dnia po pierwszym głosowaniu przeprowadza się ponowne głosowanie.</p>
			<p>5. W ponownym głosowaniu wyboru dokonuje się spośród dwóch kandydatów, którzy w pierwszym głosowaniu otrzymali kolejno największą liczbę głosów. Jeżeli którykolwiek z tych dwóch kandydatów wycofa zgodę na kandydowanie, utraci prawo wyborcze lub umrze, w jego miejsce do wyborów w ponownym głosowaniu dopuszcza się kandydata, który otrzymał kolejno największą liczbę głosów w pierwszym głosowaniu. W takim przypadku datę ponownego głosowania odracza się o dalszych 14 dni.</p>
			<p>6. Na Prezydenta Rzeczypospolitej wybrany zostaje kandydat, który w ponownym głosowaniu otrzymał więcej głosów."</p>
			<p>7. Zasady i tryb zgłaszania kandydatów i przeprowadzania wyborów oraz warunki ważności wyboru Prezydenta Rzeczypospolitej określa ustawa."</p>
		`,
		desc: ``
	},
	{
	...
	},
	{
		...
		html: `
			...
			<p>3. W razie stwierdzenia nieważności wyboru Prezydenta Rzeczypospolitej przeprowadza się nowe wybory, na zasadach przewidzianych w <a class="art-scroll" rel="prefetch" href='/128'>art. 128</a> ust. 2 dla przypadku opróżnienia urzędu Prezydenta Rzeczypospolitej.</p>
		`,
		desc: ``
	},
	{
	...
	},
	{
		...
		html: `
			...
			<p>2. Marszałek Sejmu tymczasowo, do czasu wyboru nowego Prezydenta Rzeczypospolitej, wykonuje obowiązki Prezydenta Rzeczypospolitej w razie: "</p>
			<ul>
			...
			<p>3. Jeżeli Marszałek Sejmu nie może wykonywać obowiązków Prezydenta Rzeczypospolitej, obowiązki te przejmuje Marszałek Senatu.</p>
			<p>4. Osoba wykonująca obowiązki Prezydenta Rzeczypospolitej nie może postanowić o skróceniu kadencji Sejmu.</p>
		`,
		desc: ``
	},
	{
	...
	},
	{
		...
		html: `
			...
			<p>2. Prezydent Rzeczypospolitej przed ratyfikowaniem umowy międzynarodowej może zwrócić się do Trybunału Konstytucyjnego z wnioskiem w sprawie jej zgodności z Konstytucją.</p>
			<p>3. Prezydent Rzeczypospolitej w zakresie polityki zagranicznej współdziała z Prezesem Rady Ministrów i właściwym ministrem.</p>
		`,
		desc: ``
	},
	{
		...
		html: `
			...
			<p>2. W czasie pokoju Prezydent Rzeczypospolitej sprawuje zwierzchnictwo nad Siłami Zbrojnymi za pośrednictwem Ministra Obrony Narodowej.</p>
			<p>3. Prezydent Rzeczypospolitej mianuje Szefa Sztabu Generalnego i dowódców rodzajów Sił Zbrojnych na czas określony. Czas trwania kadencji, tryb i warunki odwołania przed jej upływem określa ustawa.</p>
			<p>4. Na czas wojny Prezydent Rzeczypospolitej, na wniosek Prezesa Rady Ministrów, mianuje Naczelnego Dowódcę Sił Zbrojnych. W tym samym trybie może on Naczelnego Dowódcę Sił Zbrojnych odwołać. Kompetencje Naczelnego Dowódcy Sił Zbrojnych i zasady jego podległości konstytucyjnym organom Rzeczypospolitej Polskiej określa ustawa.</p>
			<p>5. Prezydent Rzeczypospolitej, na wniosek Ministra Obrony Narodowej, nadaje określone w ustawach stopnie wojskowe.</p>
			<p>6. Kompetencje Prezydenta Rzeczypospolitej, związane ze zwierzchnictwem nad Siłami Zbrojnymi, szczegółowo określa ustawa.</p>
		`,
		desc: ``
	},
	{
	...
	},
	{
		...
		html: `
			...
			<p>2. Radzie Gabinetowej nie przysługują kompetencje Rady Ministrów.</p>
		`,
		desc: ``
	},
	{
	...
	},
	{
		...
		html: `
			...
			<p>2. Akty urzędowe Prezydenta Rzeczypospolitej wymagają dla swojej ważności podpisu Prezesa Rady Ministrów, który przez podpisanie aktu ponosi odpowiedzialność przed Sejmem.</p>
			<p>3. Przepis ust. 2 nie dotyczy:</p>
			<ul>
	...
	},
	{
		...
		html: `
			...
			<p>3. Z dniem podjęcia uchwały o postawieniu Prezydenta Rzeczypospolitej w stan oskarżenia przed Trybunałem Stanu sprawowanie urzędu przez Prezydenta Rzeczypospolitej ulega zawieszeniu. Przepis <a class="art-scroll" rel="prefetch" href='/131'>art. 131</a> stosuje się odpowiednio.</p>
		`,
		desc: ``
	},
	{
		...
		html: `
			...
			<p>2. Do Rady Ministrów należą sprawy polityki państwa nie zastrzeżone dla innych organów państwowych i samorządu terytorialnego.</p>
			<p>3. Rada Ministrów kieruje administracją rządową.</p>
			<p>4. W zakresie i na zasadach określonych w Konstytucji i ustawach Rada Ministrów w szczególności:</p>
		`,
		desc: ``
	},
	{
		...
		html: `
			...
			<p>2. W skład Rady Ministrów mogą być powoływani wiceprezesi Rady Ministrów.</p>
			<p>3. Prezes i wiceprezes Rady Ministrów mogą pełnić także funkcję ministra.</p>
			<p>4. W skład Rady Ministrów mogą być ponadto powoływani przewodniczący określonych w ustawach komitetów.</p>
		`,
		desc: ``
	},
	{
	...
	},
	{
		...
		html: `
			...
			<p>3. Do przewodniczącego komitetu, o którym mowa w <a class="art-scroll" rel="prefetch" href='/147'>art. 147</a> ust. 4, stosuje się odpowiednio przepisy odnoszące się do ministra kierującego działem administracji rządowej.</p>
		`,
		desc: ``
	},
	{
	...
	},
	{
		...
		html: `
			...
			<p>2. Tryb powoływania i odwoływania oraz zakres działania wojewodów określa ustawa.</p>
		`,
		desc: ``
	},
	{
		...
		html: `
			...
			<p>2. Prezes Rady Ministrów jest zwierzchnikiem korpusu służby cywilnej.</p>
		`,
		desc: ``
	},
	{
	...
	},
	{
		...
		html: `
			...
			<p>2. Uchwałę o pociągnięciu członka Rady Ministrów do odpowiedzialności przed Trybunałem Stanu Sejm podejmuje na wniosek Prezydenta Rzeczypospolitej lub co najmniej 115 posłów większością 3/5 ustawowej liczby posłów.</p>
		`,
		desc: ``
	},
	{
		...
		html: `
			...
			<p>2. Członkowie Rady Ministrów ponoszą przed Sejmem również odpowiedzialność indywidualną za sprawy należące do ich kompetencji lub powierzone im przez Prezesa Rady Ministrów.</p>
		`,
		desc: ``
	},
	{
	...
	},
	{
		...
		html: `
			...
			<p>2. Prezes Rady Ministrów składa dymisję Rady Ministrów również w razie:</p>
			<ul>
			...
			<p>3. Prezydent Rzeczypospolitej, przyjmując dymisję Rady Ministrów, powierza jej dalsze sprawowanie obowiązków do czasu powołania nowej Rady Ministrów.</p>
			<p>4. Prezydent Rzeczypospolitej, w przypadku określonym w ust. 2 pkt 3, może odmówić przyjęcia dymisji Rady Ministrów.</p>
		`,
		desc: ``
	},
	{
	...
	},
	{
		...
		html: `
			...
			<p>2. Inne jednostki samorządu regionalnego albo lokalnego i regionalnego określa ustawa.</p>
			<p>3. Gmina wykonuje wszystkie zadania samorządu terytorialnego nie zastrzeżone dla innych jednostek samorządu terytorialnego.</p>
		`,
		desc: ``
	},
	{
		...
		html: `
			...
			<p>2. Samodzielność jednostek samorządu terytorialnego podlega ochronie sądowej.</p>
		`,
		desc: ``
	},
	{
		...
		html: `
			...
			<p>2. Jeżeli wynika to z uzasadnionych potrzeb państwa, ustawa może zlecić jednostkom samorządu terytorialnego wykonywanie innych zadań publicznych. Ustawa określa tryb przekazywania i sposób wykonywania zadań zleconych.</p>
			<p>3. Spory kompetencyjne między organami samorządu terytorialnego i administracji rządowej rozstrzygają sądy administracyjne.</p>
		`,
		desc: ``
	},
	{
		...
		html: `
			...
			<p>2. Dochodami jednostek samorządu terytorialnego są ich dochody własne oraz subwencje ogólne i dotacje celowe z budżetu państwa.</p>
			<p>3. Źródła dochodów jednostek samorządu terytorialnego są określone w ustawie.</p>
			<p>4. Zmiany w zakresie zadań i kompetencji jednostek samorządu terytorialnego następują wraz z odpowiednimi zmianami w podziale dochodów publicznych.</p>
		`,
		desc: ``
	},
	{
	...
	},
	{
		...
		html: `
			...
			<p>2. Wybory do organów stanowiących są powszechne, równe, bezpośrednie i odbywają się w głosowaniu tajnym. Zasady i tryb zgłaszania kandydatów i przeprowadzania wyborów oraz warunki ważności wyborów określa ustawa.</p>
			<p>3. Zasady i tryb wyborów oraz odwoływania organów wykonawczych jednostek samorządu terytorialnego określa ustawa.</p>
			<p>4. Ustrój wewnętrzny jednostek samorządu terytorialnego określają, w granicach ustaw, ich organy stanowiące.</p>
		`,
		desc: ``
	},
	{
	...
	},
	{
		...
		html: `
			...
			<p>2. Organami nadzoru nad działalnością jednostek samorządu terytorialnego są Prezes Rady Ministrów i wojewodowie, a w zakresie spraw finansowych regionalne izby obrachunkowe.</p>
			<p>3. Sejm, na wniosek Prezesa Rady Ministrów, może rozwiązać organ stanowiący samorządu terytorialnego, jeżeli organ ten rażąco narusza Konstytucję lub ustawy.</p>
		`,
		desc: ``
	},
	{
		...
		html: `
			...
			<p>2. Jednostka samorządu terytorialnego ma prawo przystępowania do międzynarodowych zrzeszeń społeczności lokalnych i regionalnych oraz współpracy ze społecznościami lokalnymi i regionalnymi innych państw.</p>
			<p>3. Zasady, na jakich jednostki samorządu terytorialnego mogą korzystać z praw, o których mowa w ust. 1 i 2, określa ustawa.</p>
		`,
		desc: ``
	},
	{
	...
	},
	{
		...
		html: `
			...
			<p>2. Sąd wyjątkowy lub tryb doraźny może być ustanowiony tylko na czas wojny.</p>
		`,
		desc: ``
	},
	{
		...
		html: `
			...
			<p>2. Ustrój i właściwość sądów oraz postępowanie przed sądami określają ustawy.</p>
		`,
		desc: ``
	},
	{
	...
	},
	{
		...
		html: `
			...
			<p>2. Sędziom zapewnia się warunki pracy i wynagrodzenie odpowiadające godności urzędu oraz zakresowi ich obowiązków.</p>
			<p>3. Sędzia nie może należeć do partii politycznej, związku zawodowego ani prowadzić działalności publicznej nie dającej się pogodzić z zasadami niezależności sądów i niezawisłości sędziów.</p>
		`,
		desc: ``
	},
	{
	...
	},
	{
		...
		html: `
			...
			<p>2. Złożenie sędziego z urzędu, zawieszenie w urzędowaniu, przeniesienie do innej siedziby lub na inne stanowisko wbrew jego woli może nastąpić jedynie na mocy orzeczenia sądu i tylko w przypadkach określonych w ustawie.</p>
			<p>3. Sędzia może być przeniesiony w stan spoczynku na skutek uniemożliwiających mu sprawowanie jego urzędu choroby lub utraty sił. Tryb postępowania oraz sposób odwołania się do sądu określa ustawa.</p>
			<p>4. Ustawa określa granicę wieku, po osiągnięciu której sędziowie przechodzą w stan spoczynku.</p>
			<p>5. W razie zmiany ustroju sądów lub zmiany granic okręgów sądowych wolno sędziego przenosić do innego sądu lub w stan spoczynku z pozostawieniem mu pełnego uposażenia.</p>
		`,
		desc: ``
	},
	{
	...
	},
	{
		...
		html: `
			...
			<p>2. Sąd Najwyższy wykonuje także inne czynności określone w Konstytucji i ustawach.</p>
			<p>3. Pierwszego Prezesa Sądu Najwyższego powołuje Prezydent Rzeczypospolitej na sześcioletnią kadencję spośród kandydatów przedstawionych przez Zgromadzenie Ogólne Sędziów Sądu Najwyższego.</p>
		`,
		desc: ``
	},
	{
	...
	},
	{
		...
		html: `
			...
			<p>2. Krajowa Rada Sądownictwa może wystąpić do Trybunału Konstytucyjnego z wnioskiem w sprawie zgodności z Konstytucją aktów normatywnych w zakresie, w jakim dotyczą one niezależności sądów i niezawisłości sędziów.</p>
		`,
		desc: ``
	},
	{
		...
		html: `
			...
			<p>2. Krajowa Rada Sądownictwa wybiera spośród swoich członków przewodniczącego i dwóch wiceprzewodniczących.</p>
			<p>3. Kadencja wybranych członków Krajowej Rady Sądownictwa trwa cztery lata.</p>
			<p>4. Ustrój, zakres działania i tryb pracy Krajowej Rady Sądownictwa oraz sposób wyboru jej członków określa ustawa.
		`,
		desc: ``
	},
	{
	...
	},
	{
		...
		html: `
			...
			<p>2. Orzeczenia Trybunału Konstytucyjnego w sprawach wymienionych w <a class="art-scroll" rel="prefetch" href='/188'>art. 188</a> podlegają niezwłocznemu ogłoszeniu w organie urzędowym, w którym akt normatywny był ogłoszony. Jeżeli akt nie był ogłoszony, orzeczenie ogłasza się w Dzienniku Urzędowym Rzeczypospolitej Polskiej \"Monitor Polski\".</p>
	...
	},
	{
		...
		html: `
			...
			<p>2. Prezesa i Wiceprezesa Trybunału Konstytucyjnego powołuje Prezydent Rzeczypospolitej spośród kandydatów przedstawionych przez Zgromadzenie Ogólne Sędziów Trybunału Konstytucyjnego.</p>
		`,
		desc: ``
	},
	{
		...
		html: `
			...
			<p>2. Sędziom Trybunału Konstytucyjnego zapewnia się warunki pracy i wynagrodzenie odpowiadające godności urzędu oraz zakresowi ich obowiązków.</p>
			<p>3. Sędziowie Trybunału Konstytucyjnego w okresie zajmowania stanowiska nie mogą należeć do partii politycznej, związku zawodowego ani prowadzić działalności publicznej nie dającej się pogodzić z zasadami niezależności sądów i niezawisłości sędziów.</p>
		`,
		desc: ``
	},
	{
	...
	},
	{
		...
		html: `
			...
			<p>2. Odpowiedzialność konstytucyjną przed Trybunałem Stanu ponoszą również posłowie i senatorowie w zakresie określonym w <a class="art-scroll" rel="prefetch" href='/107'>art. 107</a>.</p>
	...
	},
	{
		...
		html: `
			...
			<p>2. Przewodniczącym Trybunału Stanu jest Pierwszy Prezes Sądu Najwyższego.</p>
			<p>3. Członkowie Trybunału Stanu w sprawowaniu funkcji sędziego Trybunału Stanu są niezawiśli i podlegają tylko Konstytucji oraz ustawom.</p>
		`,
		desc: ``
	},
	{
	...
	},
	{
		...
		html: `
			...
			<p>2. Najwyższa Izba Kontroli podlega Sejmowi.</p>
			<p>3. Najwyższa Izba Kontroli działa na zasadach kolegialności.</p>
		`,
		desc: ``
	},
	{
		...
		html: `
			...
			<p>2. Najwyższa Izba Kontroli może kontrolować działalność organów samorządu terytorialnego, komunalnych osób prawnych i innych komunalnych jednostek organizacyjnych z punktu widzenia legalności, gospodarności i rzetelności.</p>
			<p>3. Najwyższa Izba Kontroli może również kontrolować z punktu widzenia legalności i gospodarności działalność innych jednostek organizacyjnych i podmiotów gospodarczych w zakresie, w jakim wykorzystują one majątek lub środki państwowe lub komunalne oraz wywiązują się z zobowiązań finansowych na rzecz państwa.</p>
		`,
		desc: ``
	},
	{
		...
		html: `
			...
			<p>2. Najwyższa Izba Kontroli przedstawia Sejmowi coroczne sprawozdanie ze swojej działalności.</p>
		`,
		desc: ``
	},
	{
		...
		html: `
			...
			<p>2. Prezes Najwyższej Izby Kontroli nie może zajmować innego stanowiska, z wyjątkiem stanowiska profesora szkoły wyższej ani wykonywać innych zajęć zawodowych.</p>
			<p>3. Prezes Najwyższej Izby Kontroli nie może należeć do partii politycznej, związku zawodowego ani prowadzić działalności publicznej nie dającej się pogodzić z godnością jego urzędu.</p>
		`,
		desc: ``
	},
	{
	...
	},
	{
		...
		html: `
			...
			<p>2. Zakres i sposób działania Rzecznika Praw Obywatelskich określa ustawa.</p>
		`,
		desc: ``
	},
	{
		...
		html: `
			...
			<p>2. Rzecznik Praw Obywatelskich nie może zajmować innego stanowiska, z wyjątkiem stanowiska profesora szkoły wyższej ani wykonywać innych zajęć zawodowych.</p>
			<p>3. Rzecznik Praw Obywatelskich nie może należeć do partii politycznej, związku zawodowego ani prowadzić działalności publicznej nie dającej się pogodzić z godnością jego urzędu.</p>
		`,
		desc: ``
	},
	{
	...
	},
	{
		...
		html: `
			...
			<p>2. Krajowa Rada Radiofonii i Telewizji wydaje rozporządzenia, a w sprawach indywidualnych podejmuje uchwały.</p>
		`,
		desc: ``
	},
	{
		...
		html: `
			...
			<p>2. Członek Krajowej Rady Radiofonii i Telewizji nie może należeć do partii politycznej, związku zawodowego ani prowadzić działalności publicznej nie dającej się pogodzić z godnością pełnionej funkcji.</p>
		`,
		desc: ``
	},
	{
	...
	},
	{
		...
		html: `
			...
			<p>2. Nabywanie, zbywanie i obciążanie nieruchomości, udziałów lub akcji oraz emisja papierów wartościowych przez Skarb Państwa, Narodowy Bank Polski lub inne państwowe osoby prawne następuje na zasadach i w trybie określonych w ustawie.</p>
			<p>3. Ustanowienie monopolu następuje w drodze ustawy.</p>
			<p>4. Zaciąganie pożyczek oraz udzielanie gwarancji i poręczeń finansowych przez państwo następuje na zasadach i w trybie określonych w ustawie.</p>
			<p>5. Nie wolno zaciągać pożyczek lub udzielać gwarancji i poręczeń finansowych, w następstwie których państwowy dług publiczny przekroczy 3/5 wartości rocznego produktu krajowego brutto. Sposób obliczania wartości rocznego produktu krajowego brutto oraz państwowego długu publicznego określa ustawa.</p>
		`,
		desc: ``
	},
	{
	...
	},
	{
		...
		html: `
			...
			<p>2. Zasady i tryb opracowania projektu budżetu państwa, stopień jego szczegółowości oraz wymagania, którym powinien odpowiadać projekt ustawy budżetowej, a także zasady i tryb wykonywania ustawy budżetowej określa ustawa.</p>
			<p>3. W wyjątkowych przypadkach dochody i wydatki państwa w okresie krótszym niż rok może określać ustawa o prowizorium budżetowym. Przepisy dotyczące projektu ustawy budżetowej stosuje się odpowiednio do projektu ustawy o prowizorium budżetowym.</p>
			<p>4. Jeżeli ustawa budżetowa albo ustawa o prowizorium budżetowym nie weszły w życie w dniu rozpoczęcia roku budżetowego, Rada Ministrów prowadzi gospodarkę finansową na podstawie przedłożonego projektu ustawy.</p>
		`,
		desc: ``
	},
	{
		...
		html: `
			...
			<p>2. Ustawa budżetowa nie może przewidywać pokrywania deficytu budżetowego przez zaciąganie zobowiązania w centralnym banku państwa.</p>
		`,
		desc: ``
	},
	{
	...
	},
	{
		...
		html: `
			...
			<p>2. Sejm rozpatruje przedłożone sprawozdanie i po zapoznaniu się z opinią Najwyższej Izby Kontroli podejmuje, w ciągu 90 dni od dnia przedłożenia Sejmowi sprawozdania, uchwałę o udzieleniu lub o odmowie udzielenia Radzie Ministrów absolutorium.</p>
		`,
		desc: ``
	},
	{
		...
		html: `
			...
			<p>2. Organami Narodowego Banku Polskiego są: Prezes Narodowego Banku Polskiego, Rada Polityki Pieniężnej oraz Zarząd Narodowego Banku Polskiego.</p>
			<p>3. Prezes Narodowego Banku Polskiego jest powoływany przez Sejm na wniosek Prezydenta Rzeczypospolitej, na 6 lat.</p>
			<p>4. Prezes Narodowego Banku Polskiego nie może należeć do partii politycznej, związku zawodowego ani prowadzić działalności publicznej nie dającej się pogodzić z godnością jego urzędu.</p>
			<p>5. W skład Rady Polityki Pieniężnej wchodzą Prezes Narodowego Banku Polskiego jako przewodniczący oraz osoby wyróżniające się wiedzą z zakresu finansów powoływane na 6 lat, w równej liczbie przez Prezydenta Rzeczypospolitej, Sejm i Senat.</p>
			<p>6. Rada Polityki Pieniężnej ustala corocznie założenia polityki pieniężnej i przedkłada je do wiadomości Sejmowi równocześnie z przedłożeniem przez Radę Ministrów projektu ustawy budżetowej. Rada Polityki Pieniężnej, w ciągu 5 miesięcy od zakończenia roku budżetowego, składa Sejmowi sprawozdanie z wykonania założeń polityki pieniężnej.</p>
			<p>7. Organizację i zasady działania Narodowego Banku Polskiego oraz szczegółowe zasady powoływania i odwoływania jego organów określa ustawa.</p>
		`,
		desc: ``
	},
	{
		...
		html: `
			...
			<p>2. Stan nadzwyczajny może być wprowadzony tylko na podstawie ustawy, w drodze rozporządzenia, które podlega dodatkowemu podaniu do publicznej wiadomości.</p>
			<p>3. Zasady działania organów władzy publicznej oraz zakres, w jakim mogą zostać ograniczone wolności i prawa człowieka i obywatela w czasie poszczególnych stanów nadzwyczajnych, określa ustawa.</p>
			<p>4. Ustawa może określić podstawy, zakres i tryb wyrównywania strat majątkowych wynikających z ograniczenia w czasie stanu nadzwyczajnego wolności i praw człowieka i obywatela.</p>
			<p>5. Działania podjęte w wyniku wprowadzenia stanu nadzwyczajnego muszą odpowiadać stopniowi zagrożenia i powinny zmierzać do jak najszybszego przywrócenia normalnego funkcjonowania państwa.</p>
			<p>6. W czasie stanu nadzwyczajnego nie mogą być zmienione: Konstytucja, ordynacje wyborcze do Sejmu, Senatu i organów samorządu terytorialnego, ustawa o wyborze Prezydenta Rzeczypospolitej oraz ustawy o stanach nadzwyczajnych.</p>
			<p>7. W czasie stanu nadzwyczajnego oraz w ciągu 90 dni po jego zakończeniu nie może być skrócona kadencja Sejmu, przeprowadzane referendum ogólnokrajowe, nie mogą być przeprowadzane wybory do Sejmu, Senatu, organów samorządu terytorialnego oraz wybory Prezydenta Rzeczypospolitej, a kadencje tych organów ulegają odpowiedniemu przedłużeniu. Wybory do organów samorządu terytorialnego są możliwe tylko tam, gdzie nie został wprowadzony stan nadzwyczajny.</p>
		`,
		desc: ``
	},
	{
	...
	},
	{
		...
		html: `
			...
			<p>2. Przedłużenie stanu wyjątkowego może nastąpić tylko raz, za zgodą Sejmu i na czas nie dłuższy niż 60 dni.</p>
		`,
		desc: ``
	},
	{
	...
	},
	{
		...
		html: `
			...
			<p>2. Zmiana Konstytucji następuje w drodze ustawy uchwalonej w jednakowym brzmieniu przez Sejm i następnie w terminie nie dłuższym niż 60 dni przez Senat.</p>
			<p>3. Pierwsze czytanie projektu ustawy o zmianie Konstytucji może odbyć się nie wcześniej niż trzydziestego dnia od dnia przedłożenia Sejmowi projektu ustawy.</p>
			<p>4. Ustawę o zmianie Konstytucji uchwala Sejm większością co najmniej 2/3 głosów w obecności co najmniej połowy ustawowej liczby posłów oraz Senat bezwzględną większością głosów w obecności co najmniej połowy ustawowej liczby senatorów.</p>
			<p>5. Uchwalenie przez Sejm ustawy zmieniającej przepisy rozdziałów I, II lub XII Konstytucji może odbyć się nie wcześniej niż sześćdziesiątego dnia po pierwszym czytaniu projektu tej ustawy.</p>
			<p>6. Jeżeli ustawa o zmianie Konstytucji dotyczy przepisów rozdziału I, II lub XII, podmioty określone w ust. 1 mogą zażądać, w terminie 45 dni od dnia uchwalenia ustawy przez Senat, przeprowadzenia referendum zatwierdzającego. Z wnioskiem w tej sprawie podmioty te zwracają się do Marszałka Sejmu, który zarządza niezwłocznie przeprowadzenie referendum w ciągu 60 dni od dnia złożenia wniosku. Zmiana Konstytucji zostaje przyjęta, jeżeli za tą zmianą opowiedziała się większość głosujących.</p>
			<p>7. Po zakończeniu postępowania określonego w ust. 4 i 6 Marszałek Sejmu przedstawia Prezydentowi Rzeczypospolitej uchwaloną ustawę do podpisu. Prezydent Rzeczypospolitej podpisuje ustawę w ciągu 21 dni od dnia przedstawienia i zarządza jej ogłoszenie w Dzienniku Ustaw Rzeczypospolitej Polskiej.</p>
		`,
		desc: ``
	},
	{
		...
		html: `
			...
			<p>2. Ustawy wprowadzające w życie <a class="art-scroll" rel="prefetch" href='/176'>art. 176</a> ust. 1 w zakresie dotyczącym postępowania przed sądami administracyjnymi zostaną uchwalone przed upływem 5 lat od dnia wejścia w życie Konstytucji. Do czasu wejścia w życie tych ustaw obowiązują przepisy dotyczące rewizji nadzwyczajnej od orzeczeń Naczelnego Sądu Administracyjnego.</p>
		`,
		desc: ``
	},
	{
		...
		html: `
			...
			<p>2. Odwołanie od orzeczenia kolegium rozpoznaje sąd.</p>
		`,
		desc: ``
	},
	{
	...
	},
	{
		...
		html: `
			...
			<p>2. Postępowanie w sprawach o ustalenie przez Trybunał Konstytucyjny powszechnie obowiązującej wykładni ustaw wszczęte przed wejściem w życie Konstytucji podlega umorzeniu.</p>
			<p>3. Z dniem wejścia w życie Konstytucji uchwały Trybunału Konstytucyjnego w sprawie ustalenia wykładni ustaw tracą moc powszechnie obowiązującą. W mocy pozostają prawomocne wyroki sądu oraz inne prawomocne decyzje organów władzy publicznej podjęte z uwzględnieniem znaczenia przepisów ustalonego przez Trybunał Konstytucyjny w drodze powszechnie obowiązującej wykładni ustaw.</p>
		`,
		desc: ``
	},
	{
	...
	},
	{
		...
		html: `
			...
			<p>4. Połączenie mandatu posła lub senatora z funkcją lub zatrudnieniem, których dotyczy zakaz określony w <a class="art-scroll" rel="prefetch" href='/103'>art. 103</a>, powoduje wygaśnięcie mandatu po upływie miesiąca od dnia wejścia w życie Konstytucji, chyba że poseł albo senator wcześniej zrzeknie się funkcji albo ustanie zatrudnienie.</p>
			...
			<p>7. Obowiązujące w dniu wejścia w życie Konstytucji akty prawa miejscowego oraz przepisy gminne stają się aktami prawa miejscowego w rozumieniu <a class="art-scroll" rel="prefetch" href='/87'>art. 87</a> ust. 2 Konstytucji.</p>
		`,
		desc: ``
	},
	{
