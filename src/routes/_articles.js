const articles = [
	...
	},
	{
		...
		desc: `
			...
			<p>Wyjątki od zasady uniwersalności mogą odnosić się jedynie do cudzoziemców i muszą zostać ustanowione w ustawie. Dopuszczalny zakres wyjątków należy ustalić w relacji z art. 31 ust. 3, art. 32 (zasada równości) oraz art. 30 Konstytucji (zasada godności).</p>
		`
	},
	{
		title: 'Art. 38',
	...
	},
	{
		...
		<ul>
			<li>[1] Artykuł 5: Nikt nie może być poddany torturom albo okrutnemu, nieludzkiemu lub poniżającemu traktowaniu lub karaniu</li>
			<li>[2] Artykuł 3: (…) W tym celu są i pozostaną zakazane w stosunku do wyżej wymienionych osób w każdym czasie i w każdym miejscu: a) zamachy na życie i nietykalność cielesną w szczególności zabójstwa we wszelkiej postaci, okaleczenia, okrutne traktowanie, tortury i męki, b) branie zakładników, c) zamachy na godność osobistą, a w szczególności traktowanie poniżające i upokarzające (…)</li>
			<li>[3] Artykuł 3: Nikt nie będzie poddany torturom ani nieludzkiemu lub poniżającemu traktowaniu lub karaniu</li>
			<li>[4] Artykuł 7: Nikt nie będzie poddawany torturom albo okrutnemu, nieludzkiemu bądź poniżającemu traktowaniu lub karaniu. W szczególności nikt nie będzie poddawany, bez swej swobodnie wyrażonej zgody, doświadczeniom lekarskim lub naukowym</li>
			<li>[5] Zob. A. Ploszka, Zakaz tortur. Czy na pewno bezwzględny? [w]: Przegląd Prawniczy UW, nr I-II, rok XI, Warszawa 2012 r., str. 124</li>
			<li>[6] Zob. wyrok z dnia 24.07.2014 r w sprawie Al Nashiri przeciwko Polsce, skarga nr 28761/11, § 507 (wyrok w sprawie tajnych więzień CIA w Polsce)</li>
			<li>[7] Zob. Konwencja o Ochronie Praw człowieka i Podstawowych Wolności. Tom I. Komentarz do artykułów 1-18. L. Garlicki red., Wydawnictwo C. H. Beck, Warszawa 2010 r., str. 99.</li>
			<li>[8] Rezolucja Zgromadzenia Ogólnego ONZ 3452(XXX)</li>
			<li>[9] Dz. U. z 1989‏. Nr 63, poz. 378</li>
			<li>[10] Por. Sprawa Al Nashiri przeciwko Polsce (skarga nr 28761/11, wyrok z dnia 24.07.2014‏)</li>
			<li>[11] Por. sprawa Piechowicz przeciwko Polsce (skarga nr 2007 r.1/07, wyrok z dnia 17.04.2012 r‏.)</li>
			<li>[12] Już wówczas kilka organizacji międzynarodowych połączyło swoje siły w celu znalezienia dodatkowych, bardziej pragmatycznych, sposobów zapobiegania takim nadużyciom. Szwajcarski filantrop Jean Jacques Gautier, zainspirowany wynikami wizyt więzień przeprowadzanych przez Międzynarodowy Komitet Czerwonego Krzyża podczas wojny, starał się stworzyć system regularnych wizyt wszystkich miejsc zatrzymań na całym świecie. W 1977 r‏. powołał Stowarzyszenie Zapobiegania Torturom (APT), niezależną organizację pozarządową z siedzibą w Genewie, która od początku broniła prostej, lecz nowatorskiej zasady wysuniętej przez niego, iż wizytowanie miejsc, w których przebywają ludzie pozbawieni wolności to najbardziej skuteczna metoda zapobiegania torturom i maltretowaniu. Przez wiele lat członkowie APT zabiegali o utworzenie takiego systemu w strukturach ONZ.</li>
			<li>[13] Dz. U. z 2007 r. nr 30, poz. 192</li>
			<li>[14] Dz. U. z 2014 r., poz. 1648</li>
		</ul>
		`
	},
	{
	...
	},
	{
		...
		desc: `
			...
			<ul>
				<li>przestępstwo musi być popełnione przez funkcjonariusza publicznego (lub na jego zlecenie),</li>
				<li>oraz w stosunku do sprawcy tego czynu z przyczyn politycznych nie wszczęto lub przerwano (zawieszono) postępowanie (dochodzenie, śledztwo).</li>
			</ul>
	...
	},
	{
		...
		<p>Z takiego ukształtowania artykułu 45 wynika także zasada dostępności do sądów. Powinno być to względnie łatwe (także w sprawach rozpoznawanych przez wyższe instancje), a wszelkie ograniczenia w tym zakresie muszą być zgodne z art. 31 ust. 3 Konstytucji.</p>
	...
	},
	{
		...
		desc: `
			...
			<p>Z prawa do ochrony życia prywatnego wynika obowiązek władz publicznych, by uregulować te zagadnienia oraz powstrzymać się od ingerencji w sfery prywatne. Przepis ten powiązany jest bezpośrednio z wolnością człowieka (art. 31 ust. 1) i wolnością osobistą jednostki (art. 41).</p>
	...
	},
	{
		...
		`,
		desc: `
			<p>Swoboda poruszania się jest tradycyjną, klasyczną wolnością jednostki, zazwyczaj traktowaną jako przejaw realizacji wolności osobistej (art. 31 ust. 2). Artykuł 52 należy postrzegać również jako przejaw prawa do decydowania o życiu osobistym (art. 47) oraz jako przykład ogólnego, wolnościowego statusu jednostki (art. 31 ust. 1).</p>
	...
	},
	{
		...
		desc: `
			...
			<p>Wolność pozyskiwania informacji dotyczyć może zbierania danych z dowolnych sfer życia publicznego (art. 61 Konstytucji nakłada na władze obowiązek udzielania odpowiednich informacji) lub prywatnego.</p>
	...
	},
	{
		...
		`,
		desc: `
			<p>Wolność zrzeszania się ujęto jako zasadę ustrojową (społeczeństwa obywatelskiego) w art. 12 Konstytucji. Jest ona źródłem szeregu praw podmiotowych, takich jak:</p>
			<ul>
	...
	},
	{
		...
		`,
		desc: `
		<p>Artykuł ten konkretyzuje ogólną wolność zrzeszania się z art. 58 Konstytucji. Wolność działalności w związkach zawodowych jest niezwykle istotna z perspektywy historii Polski, dlatego przepis ten jest szczególnie rozbudowany i reguluje różnorodne zagadnienia. Gwarantuje to bowiem, że ograniczenia tej wolności zgodne z art. 31 ust. 3 zawarte w ustawie nie mogą wykraczać poza szczegółowo określone ramy. Formy zrzeszania się przewidziane w tym przepisie Konstytucji to:</p>
		<ul>
	...
	},
	{
		...
		desc: `
			...
			<ul>
				<li>zabezpieczenia egzystencji (pokrywa się to częściowo z normą wynikającą z art. 67 ust. 1, odrębne uregulowanie sytuacji osób z niepełnosprawnościami sugeruje dopuszczalność przyznania im pewnych preferencji);</li>
	...
	},
	{
		...
		html: `
			...
			<p>2. Pierwsze posiedzenia Sejmu i Senatu Prezydent Rzeczypospolitej zwołuje na dzień przypadający w ciągu 30 dni od dnia wyborów, z wyjątkiem przypadków określonych w <a href='/98'>art. 98 ust. 3 i 5</a>.</p>
		`,
		desc: ``
	},
	{
	...
	},
	{
		...
		`,
		desc: `
			<p>Jak wskazał Trybunał Konstytucyjny art. 217 jest szczególnie powiązany z art. 84 (obowiązek ponoszenia ciężarów publicznych), art. 82 (troska o wspólne dobro), art. 83 (obowiązek przestrzegania prawa) i art. 1 (państwo jako dobro wspólne obywateli) – wyrok TK z 6 marca 2002, P 7/00.</p>
