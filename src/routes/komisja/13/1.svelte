...
<div in:fly={{ y: 100, duration: 1000 }}>
  ...
  <p class="rep-statement">
    ...
    Wszystkie propozycje tytułów odpowiadają treści rozdziału I. Różnice mają
    charakter tylko werbalny.
  </p>
  ...
  <p class="rep-statement">
    ...
    Komisji. Tak więc większością głosów Komisja przyjęła, że rozdział pierwszy
  ...
  <p class="rep-statement">
    <strong>Poseł Aleksander Kwaśniewski (SLD):</strong>
    Rozumiem więc, że posła J. Szymańskiego mogę dopisać jako wnioskodawcę do
    formuły zgłoszonej na poprzednim posiedzeniu przez posłów: T. Iwińskiego 1J.
    Zdradę.
  </p>
  <p class="rep-statement">
    <strong>Poseł Janusz Szymański (UP):</strong>
  ...
  <p class="rep-statement">
    <strong>Poseł Aleksander Kwaśniewski (SLD):</strong>
    Powrócimy do tej kwestii za chwilę. Proponuję, abyśmy teraz rozstrzygnęli
    losy obecnego art. 1, gdyż zostały zgłoszone wnioski o jego wykreślenie.
  </p>
  <p class="rep-statement">
  ...
  <p class="rep-statement">
    <strong>Poseł Aleksander Kwaśniewski (SLD):</strong>
    Uważam, że biorąc pod uwagę tytuł ustawy konstytucyjnej z 23 kwietnia 1992
    r. określający tytuł nowej konstytucji, przebieg dotychczasowych prac oraz
    fakt, że wszystkie siedem projektów to projekty Konstytucji Rzeczypospolitej
    Polskiej, sprawę tytułu nowej konstytucji należy uznać za przesądzoną.
    Powracamy do art. 1. Przypominam, że zgłoszono kilka wniosków o wykreślenie
    art. | w jego obecnej treści, gdyż jest tautologiczny. Kwestię tę musimy
    więc rozstrzygnąć w głosowaniu.
  </p>
  <p class="rep-statement">
    <strong>Przedstawiciel Prezydenta RP, prof. Andrzej Rzepliński:</strong>
    Do brzmienia art. 1 zaproponowanego przez prof. M. Pietrzaka na poprzednim
    posiedzeniu, proponujemy dodanie ust. 2. Brzmienie art. 1 byłoby więc
    następujące: „Ust. 1. Państwo Polskie jest jednolitą i niepodzielną
    republiką, Jego tradycyjną nazwą jest — Rzeczpospolita Polska. Ust. 2.
    Państwo Polskie jest wspólnym dobrem wszystkich obywatel”.
  </p>
  <p class="rep-statement">
    <strong>Poseł Ryszard Bugaj (UP):</strong>
    ...
    bowiem założyć, że Polska może być monarchią. Należy również przypomnieć, że
    padły głosy za utrzymaniem art. 4, choćby z racji nawiązania do tradycji
    konstytucji marcowej, której art. 1 miał taką właśnie treść. Jestem więc
    przeciwny skreśleniu art. 1.
  </p>
  <p class="rep-statement">
    <strong>Poseł Aleksander Kwaśniewski (SLD):</strong>
    ...
    składał z 4 ustępów. „Ust. 1. Rzeczpospolita Polska jest wspólnym dobrem
    wszystkich obywateli. Ust. 2. Wskrzeszona i powtómie odbudowana walką i
    ofiarą najlepszych swoich synów ma być przekazywana w spadku dziejowym z
    pokolenia na pokolenie. Ust. 3. Każde pokolenie obowiązane jest wysiłkiem
    własnym wzmóc siły i powagę Rzeczypospolitej. Ust. 4. Za spełnienie tego
    obowiązku odpowiada przed potomnością swoim honorem i swoim imieniem". Czy
    są wnioski lub uwagi do przedłożonych propozycji?
  </p>
  <p class="rep-statement">
    ...
    Zawarta w tym punkcie treść art. 1 nie jest zgodna z moim wnioskiem. Swoją
    treść art. 1 przedstawiłem przed chwilą.
  </p>
  <p class="rep-statement">
    ...
    tłumaczeniem łacińskich wyrazów: res publica. Nie jest to więc wyraz polski.
  </p>

  <!--<hr><p class="page-break">strona 7</p><hr>-->
  ...
  <p class="rep-statement">
    <strong>Senator Alicja Grześkowiak (NSZZ „S”):</strong>
    Przedłożoną formułę zgłaszam jako poprawkę. Głos z sali: Głosowanie nad
    poprawkami już się odbyło.
  </p>
  <p class="rep-statement">
    <strong>Senator Alicja Grześkowiak (NSZZ „S”):</strong>
  ...
  <p class="rep-statement">
    ...
    udział w głosowaniu, nie zmieniłoby to wyniku w istotny sposób. Dodam, że
    również zamierzam złożyć wniosek mniejszości w tej kwestii. Jeżeli chodzi o
    kolejne artykuły, to uważam, że powinniśmy ustalić, że głosowanie będzie
    przeprowadzone wówczas, gdy wszystkie propozycje zostaną zestawione w formie
    pisemnej.
  </p>
  <p class="rep-statement">
    <strong>Poseł Aleksander Kwaśniewski (SLD):</strong>
    Zgadzam się z propozycją posła R. Bugaja. Senator A. Grześkowiak chcę
    natomiast poinformować, że jej wniosek dotyczący nie tylko brzmienia art. 1,
    ale także dotyczący brzmienia tytułu, został poddany pod głosowanie mimo
    nieobecności wnioskodawcy. Powracam do kwestii ustalenia nowego brzmienia
    art. 1.
  </p>
  <p class="rep-statement">
  ...
  <!--<hr><p class="page-break">strona 8</p><hr>-->
  ...
  <p class="rep-statement">
    ...
    rządów. Rzeczpospolita jako republika szlachecka była monarchią. W obecnej
    formie republika oznacza formę sprawowania władzy. Ponadto warto pamiętać,
    że są w Polsce partie polityczne o programie monarchistycznym.
  </p>
  <p class="rep-statement">
    ...
    monarchistyczne są dłuższe.
  </p>
  <p class="rep-statement">
    <strong>Senator Jan Orzechowski (PSL):</strong>
    Uważam, że w art. 1 powinny znaleźć się elementy obecnego art. 2 iart. 5.
    Nie uważam natomiast za konieczne pisanie o republikańskiej formie rządów.
  </p>
  <p class="rep-statement">
    <strong>Przedstawiciel Prezydenta RP, prof. Andrzej Rzepliński:</strong>
    Z dyskusji wynika, że treść art. 1 jest postrzegana przez treść obecnego
    art. 5. Projekt konstytucji Unii Wolności obejmuje tylko zasady państwa. Mam
    więc uwagę do formuły mówiącej o urzeczywistnianiu zasad sprawiedliwości
    społecznej. Utrzymanie tej formuły przy jednoczesnym przyjęciu zasady
    ostateczności orzeczeń Trybunału Konstytucyjnego dotyczących zgodności ustaw
    z konstytucją, oznaczać będzie oddanie nieograniczonej władzy Trybunałowi
    Konstytucyjnemu. Każde orzeczenie Trybunału Konstytucyjnego, nawet jeżeli
    będzie sprzeczne z poprzednimi, da się utrzymać. Nie znaczy to, że należy
    koniecznie zrezygnować z całej formuły, która jest jednak trudna do
    interpretacji w kategoriach prawnych. Znacznie łatwiej jest interpretować
    pojęcie państwa socjalnego. Najnowsze konstytucje definiując państwo
    najczęŚciej ograniczają się do formuły państwa prawnego i ewentualnie
    społecznego, czyli socjalnego. Chcę również dodać, iż uważam, że ze względów
    redakcyjnych bardziej poprawna jest formuła: państwo prawne, a nie państwo
    prawa.
  </p>
  <p class="rep-statement">
    <strong>Senator Alicja Grześkowiak (NSZZ „S”):</strong>
  ...
  <p class="rep-statement">
    <strong>Poseł Aleksander Kwaśniewski (SLD):</strong>
    Uważam, że najpierw należy jednak rozstrzygnąć kwestię zapisania, lub nie,
  ...
  <p class="rep-statement">
    ...
    „zapewnia ochronę”. Uważam ją za lepszą z punktu widzenia tego, co jest
    treścią art. 3. Proponuję również, aby zamiast terminu: „prawa człowieka”
    użyć formuły: „wolności i prawa człowieka”. Jest to wskazane ze względu na
    odbiór społeczny oraz ze względu na formułę stosowaną w rozdziale II. Sądzę
    ponadto, że od formuły: „strzeże niepodległości i całości swojego
    terytorium”, lepsza byłaby formuła: „strzeże niepodległości i
    nienaruszalności swojego terytorium”. Nie można bowiem wykluczyć sytuacji, w
    której właściwe organy, w sposób zgodny Z prawem podejmą decyzje dotyczące
    terytorium. Mam również uwagę do art. 6, do formuły: „swoich demokratycznie
    wybranych przedstawicieli". Chodzi o to, że niektóre urzędy będą sprawowane
    bez mandatu pochodzącego z demokratycznych wyborów, lecz z demokratyczną
    legitymacją. Dotyczy to zwłaszcza sędziów, a także urzędów obsadzanych przez
    Sejm. Myślę więc, że można rozważyć rezygnację z formuły: „demokratycznie
    wybranych”. Proponuję rozważyć również, aby art. 6 rozpoczynał się od
    wyrazów: „Suwerenem Rzeczypospolitej Polskiej jest ogół obywateli tworzących
  ...
  <p class="rep-statement">
    ...
    środowiska oraz do wniosku grupy członków Komisji, którzy proponują wpisanie
    do konstytucji zasad zrównoważonego rozwoju. Moja propozycja polega na tym,
    aby art. 3 składał się z dwóch ustępów. Ust. I obejmowałby obecną treść art.
    3 z wyjątkiem końcowego "fragmentu. Ust. 2 miałby zaś następującą treść:
    „Rzeczpospolita Polska zapewnia ochronę środowiska, stosując zasady
    zrównoważonego rozwoju”. Wniosek grupy członków Komisji mówi o trwałym i
    zrównoważonym rozwoju. Jest to definicja podwójna. Lepiej więc mówić o
    zrównoważonym rozwoju, co oznacza zaspokojenie potrzeb obecnego pokolenia z
    uwzględnieniem potrzeb przyszłych pokoleń.
  </p>
  <p class="rep-statement">
    <strong>Poseł Aleksander Kwaśniewski (SLD):</strong>
  ...
  <p class="rep-statement">
    <strong>Poseł Janusz Szymański (UP):</strong>
    Opowiadam się za tym, aby art. 2 formułował zasadę zwierzchnictwa narodu 1
    miał brzmienie następujące: „Ust. 1. W Rzeczypospolitej Polskiej władza
    zwierzchnia należy do Narodu. Ust. 2. Naród sprawuje władzę przez swych
    przedstawicieli lub bezpośrednio”. Argumenty na rzecz usytuowania w art. 2
    zasady suwerenności narodu zostały już przedstawione. Nie będę więc ich
    powtarzał.
  </p>
  <p class="rep-statement">
    <strong>Poseł Jerzy Ciemniewski (UW):</strong>
    ...
    jednak rozszerzenia katalogu, lecz przeciwnie, jego skreślenie. Warto dodać,
    że każde państwo strzeże niepodległości i całości swojego terytorium.
    Problemy widać już przy kwestii kultury i języka. O ochronie praw człowieka
    jest mowa w rozdziale II.
  </p>

  <!--<hr><p class="page-break">strona 10</p><hr>-->
  ...
  <p class="rep-statement">
    ...
    ograniczonej liczbie haseł. Haseł nie da się jednak zupełnie wyeliminować z
    tekstu konstytucji. Gdyby tak się stało, to konstytucja byłaby regulaminem
    proceduralnym. Przyjmując skrajną postawę należałoby postulować skreślenie
    zwrotu: „demokratyczne państwo” jako również wzniosłego hasła. Uważam, że w
    art. 3 zawarte są bardzo istotne treści mające sens normatywny, o czym już
    mówiłem. Proponuję również wprowadzenie do art. 3 formuły o zrównoważonym
    rozwoju. Korzystając z okazji chcę również odnieść się polemicznie do
    wypowiedzi prof. A. Rzeplińskiego na temat formuły mówiącej o gwarantowaniu
    praw człowieka. Pojęcie gwarancji praw jest na gruncie nauk prawnych i
    praktyki pojęciem znanym.
  </p>
  <p class="rep-statement">
  ...
  <p class="rep-statement">
    ...
    pojęć z poprzedniej epoki. Kwestia druga to apel o przeniesienie dyskusji na
    wyższy poziom. Jeżeli bowiem pada postulat skreŚlenia jakiegoś pojęcia czy
    ograniczenia wyliczenia celów państwa, nie oznacza to sprzeciwiania się
    celom i wartościom, lecz chodzi o jurydyczność przepisów konstytucji. Do
    dyskusji pzostaje więc problem, czy konieczne jest odrębne wymienienie strz
    żenia języka, gdyż język chyba mieści się w dziedzictwie kultury.
  </p>

  <!--<hr><p class="page-break">strona 11</p><hr>-->

  <p class="rep-statement">
    <strong>Poseł Janusz Szymański (UP):</strong>
    Rozpocznę od uwagi polemicznej, że nie od deklaratywnego przepisu o
    wszechstronnym, czy zrównoważonym Tozwoju zależy rozwój określonego regionu
    czy państwa. Rozwój ten zależy przede wszystkim od mądrości ludzi. Uważam,
    że po art. 1 mówiącym o państwie, po art. 2 mówiącym o zwierzchnictwie
    narodu, art. 3 powinien formułować zasadę praworządności i zasadę legalizmu.
    Art. 3 miałby brzmienie: „Ust. 1. Przestrzeganie praw Rzeczypospolitej
    Polskiej jest podstawowym obowiązkiem każdego organu państwa. Ust. 2.
    Wszystkie organy władzy i administracji państwowej działają na podstawie
    przepisów prawa”.
  </p>
  <p class="rep-statement">
    <strong>Senator Jerzy Madej (KD):</strong>
    Mam odmienny pogląd niż poseł J. Szymański, gdyż uważam, że obecny art. 3
    powinien być art. 2, podejmuje bowiem podstawowe i generalne zadania
    ...
    chodzi o rozwój wszechstronny i trwały. Chodzi o rozwój z myślą o przyszłych
    pokoleniach. Oznaczać to może nawet ograniczenie obecnego tempa rozwoju, po
    to aby nie zniszczyć zasobów, które powinny służyć również przyszłym
    pokoleniom. Nie można postępować według zasady: po nas choćby potop. Jestem
    więc za przyjęciem formuły zrównoważonego rozwoju, zwłaszcza że termin ten
    zyskał już uznanie również w Polsce.
  </p>
  <p class="rep-statement">
    <strong>Przedstawiciel Polskiego Towarzystwa Ekonomicznego:</strong>
    prof. Zdzisław Sadowski: Muszę zaprotestować przeciwko posądzeniu mnie o
    dążenie do posługiwania się archaicznymi zwrotami. Jeżeli kogoś razi użycie
    zwrotu „wszechstronny rozwój” na takiej zasadzie, że w przeszłości był on
    używany nieprawidłowo, to ja mogę to zrozumieć. Nie będę się upierał przy
    tym pojęciu. Chcę natomiast zwrócić uwagę, że pojęcie zrównoważonego rozwoju
    ...
    rozwój” jest pojęciem nieostrym dlatego, że dzisiejszy rozwój opiera się na
    innowacyjności, która powoduje ciągłe wytrącanie z równowagi. Rozwój ma więc
    być niezrównoważony.
  </p>
  <p class="rep-statement">
    <strong>Poseł Aleksander Kwaśniewski (SLD):</strong>
    ...
    I jest następujące: „Ust. 1. Państwo Polskie jest suwerenną, jednolitą i
    niepodzielną republiką. Ust. 2. Rzeczpospolita Polska jest wspólnym dobrem
    wszystkich obywateli urzeczywistniającym zasady sprawiedliwości społecznej.
    Ust. 3. Rzeczpospolita Polska jest demokratycznym państwem prawnym. Ust. 4.
    Rzeczpospolita Polska gwarantuje prawa człowieka, strzeże niepodległości i
    nienaruszalności swojego terytorium, strzeże dziedzictwa i kultury Narodu
    oraz zapewnia ochronę Środowiska i rozwój społeczno-gospodarczy kraju”.
    Brzmienie art. 2 jest następujące: „Ust. 1. Władza zwierzchnia w
    Rzeczypospolitej Polskiej należy do ogółu obywateli — tworzących Naród.
    Naród sprawuje władzę przez swych przedstawicieli lub bezpośrednio”. Ponadto
    zgłoszone zostały: prezentowana już poprawka senatora J. Madeja oraz
    poprawka senator A. Grześkowiak, będąca treścią art. 2 i art. 3 projektu
    senackiego. Za chwilę ogłoszę przerwę w obradach. Przedtem chcę jednak
    prosić senatora J. Madeja, posła J. Jaskiemię, posła L. Pastusiaka oraz
    senatora S$. Pastuszkę, aby wzięli udział w spotkaniu z udziałem
    przedstawicieli Biura Legislacyjnego i sekretariatu Komisji. Celem spotkania
    będzie uporządkowanie zgłoszonych propozycji poprawek tak, aby mogły one być
    przedmiotem głosowania po przerwie. Ogłaszam przerwę do godz. 15. [Po
    przerwie]
  </p>
  <p class="rep-statement">
    <strong>Poseł Aleksander Kwaśniewski (SLD):</strong>
    Wznawiam — po przerwie — obrady Komisji. Uczestnicy posiedzenia otrzymali
    materiał noszący tytuł: „Propozycje brzmienia art. 1-4 zgłoszone na
    posiedzeniu Komisji Konstytucyjnej w dniu 7 lutego 1995 r.” Za chwilę będą
    one podstawą głosowań. Wcześniej jednak chciałbym, aby Komisja rozstrzygnęła
    dwie kwestie natury bardziej szczegółowej. Kwestia pierwsza to pytanie, czy
    wśród cech opisujących państwo ma być określenie mówiące o ustroju
    republikańskim, czy też nie.
  </p>
  <p class="rep-statement">
    <strong>Poseł Jerzy Zdrada (UW):</strong>
  ...
  <p class="rep-statement">
    ...
    „państwie prawnym . Zmiana tej formuły spowoduje, że orzecznictwo będzie się
  ...
  <p class="rep-statement">
    <strong>Ekspert Komisji, prof:</strong>
    Kazimierz Działocha: Uważam, że poseł J. Ciemniewski ma rację. Formuła
    „państwa prawnego” znajduje się w naszym prawie konstytucyjnym od grudnia
    1989 r. i weszła na trwałe do orzecznictwa Trybunału Konstytucyjnego. Czy
    zatem warto zmieniać coś, co się sprawdziło, jest przyjęte i funkcjonuje w
    obrocie prawnym? Nie mam obaw, że Trybunał Konstytucyjny będzie się
    dopatrywał różnic merytorycznych na skutek różnicy formuł. Jest bowiem tak,
    że sam Trybunał stawia znak równości między tymi dwiema formułami. Znajduje
    to również wyraz w niektórych orzeczeniach i uzasadnieniach. Uważam więc, że
    między tymi dwiema formułami nie ma istotnych różnic. Może więc pozostać
    formuła mówiąca o „państwie prawnym”.
  </p>
  <p class="rep-statement">
    <strong>Przedstawiciel Prezydenta RP, prof. Andrzej Rzepliński:</strong>
  ...
  <p class="rep-statement">
    ...
    wniosek o przyjęcie formuły: „państwo prawne” przy określeniu cech państwa w
    art. 1. Stwierdzam, że w głosowaniu za formułą: „państwo prawne”
    opowiedziało się 20 członków Komisji. Poddaję pod głosowanie wniosek o
    przyjęcie formuły: „państwo prawa” przy określeniu cech państwa w art. 1.
    Stwierdzam, że w głosowaniu za formułą: „państwo prawa” opowiedziało się 5
    członków Komisji. Wstrzymało się od głosu 4 członków Komisji. Tak więc
    przyjęta została formuła: „państwo prawne”, Proponuję, aby wnioskodawcy
    poszczególnych propozycji uwzględnili w nich wyniki głosowań. Przystępujemy
    do analizy propozycji brzmienia art. 1-4 zgłoszonych w dniu dzisiejszym.
    Proszę o zmodyfikowane brzmienie pierwszej propozycji.
  </p>
  <p class="rep-statement">
    <strong>Poseł Jerzy Zdrada (UW):</strong>
    Proponujemy, aby art. 2 naszej propozycji stał się art. 1, a art. 3 — art.
    2.
  </p>
  <p class="rep-statement">
    <strong>Poseł Janusz Szymański (UP):</strong>
  ...
  <p class="rep-statement">
    ...
    wniosków z punktu widzenia wyników głosowań. Wniosek nr 2 zgłosił poseł J.
    Jaskiernia. Pobyt autora wniosku w szpitalu utrudnia weryfikację brzmienia
    propozycji. Autorami wniosku nr 3 są posłowie: T. Iwiński i J. Szymański.
    Czy poza zmianą wyrazu: „prawa” na: „prawnym” są inne propozycje zmian? Nie
    ma.
  </p>
  <p class="rep-statement">
    <strong>Poseł Tadeusz Mazowiecki (UW):</strong>
  ...
  <!--<hr><p class="page-break">strona 13</p><hr>-->

  <p class="rep-statement">
    <strong>Ekspert Komisji, prof. Wiktor Osiatyński:</strong>
    : Mój duży problem to końcowa część art. 3, czyli formuła:
    „urzeczywistniającym zasady sprawiedliwości społecznej”. Uważam, że jest to
    problem o ogromnej doniosłości. Należy więc uświadomić sobie wszystkie jego
    ...
    jaką jest niewątpliwie pomoc społeczna, czy też będzie rodziło po stronie
    obywateli roszczenie do rezultatów takich działań. Obawiam się, że
    sformułowanie: „urzeczywistniającym zasady sprawiedliwości społecznej” rodzi
    po stronie obywateli roszczenie do rezultatów działań socjalnych. Ponadto
    chcę dodać, że w konstytucjach państw demokratycznych występuje pojęcie
    sprawiedliwości społecznej. Tak jest m.in. we Włoszech, lecz formuła ta nie
    ma charakteru jurydystycznie obowiązującego. Natomiast w konstytucji
    niemieckiej, na podstawie której zbudowano ogromne państwo socjalne,
    znajduje się sformułowanie, zgodnie z którym RFN jest państwem prawnym 1
    ...
    związku z omawianym zagadnieniem chcę przedstawić kilka argumentów. Kwestia
    sprawiedliwości społecznej została wprowadzona do konstytucji w okresie
    rządów E. Gierka, a ściślej mówiąc w 1976 r. Pojmowanie sprawiedliwości
    społecznej, zwłaszcza w orzecznictwie Trybunału Konstytucyjnego 1
    działalności Rzecznika Praw Obywatelskich, wiąże się przede wszystkim z
    roszczeniem do pewnych działań redystrybucyjnych. Pierwsze pytanie dotyczy
    więc tego, czy konstytucja ma zakładać — zwłaszcza w okresie reform
    rynkowych — jako cel państwa działanie redystrybucyjne, czy ma dopuszczać
    działania redystrybucyjne jako środek wówczas, gdy celem jest na przykład
    to, aby ludzie nie umierali z głodu i z biedy, czyli żeby wtedy dopuszczać
    działania redystrybucyjne, kiedy chodzi o spełnienie zasady bezpieczeństwa
    socjalnego. Chcę powiedzieć, że w Świecie powstały trzy modele państwa
    socjalnego, czy państwa dobrobytu: skandynawski, zachodnioniemiecki i
    anglosaski. Tylko model skandynawski przyjmuje jako wartość sprawiedliwość,
    czy redystrybucję. Model niemiecki i anglosaski przyjmuje jako wartość
    bezpieczeństwo socjalne. Ma to ogromne znaczenie, zarówno jeżeli chodzi o
    konsekwencje, jak i postawy. Jeżeli chodzi o postawy, to obawiam się, że
    sformułowanie mówiące o urzeczywistnianiu zasad sprawiedliwości społecznej —
    w odróżnieniu od państwa socjalnego i nawet formuły mówiącej o kierowaniu
    się zasadami sprawiedliwości społecznej — może rodzić postawy roszczeniowe
    bardziej niż postawy odpowiedzialnoŚci za samego siebie i własne życie, przy
    jedynie pomocniczej roli państwa. Ważne jest również to, aby członkowie
    Komisji byli świadomi, że sformułowanie w konstytucji zwrotu o
    urzeczywistnianiu zasad sprawiedliwości społecznej — w państwie
    konstytucyjnym, a nie w państwie deklaratywnym — oznacza praktycznie
    przeniesienie 80 proc. decyzji władczych, w tym także budżetowych, do
    Trybunału Konstytucyjnego. Taka decyzja może być oczywiście podjęta, ale
    należy być świadomym, że wówczas Trybunał Konstytucyjny będzie miał podstawę
    do decydowania o rozstrzygnięciach budżetowych, a nie parlament, gdyż taka
    będzie norma konstytucyjna. Osobiście postuluję, iż lepszą formułą,
    zwłaszcza w świetle przyjęcia formuły o państwie prawnym, byłaby formuła o
    państwie prawnym i socjalnym jak w konstytucji RFN, albo formuła mówiąca o
    kierowaniu się zasadami sprawiedliwości lub formuła o kierowaniu się
    zasadami bezpieczeństwa 'socjalnego. Chodzi bowiem o to, aby cele socjalne
    były w konstytucji, lecz aby to jednocześnie nie rodziło roszniwelacyjnych
  ...
  <p class="rep-statement">
    ...
    się, że nie jest to takie proste. Problemem tym zajmowaliśmy się stosunkowo
    długo podczas prac podkomisji podstaw ustroju politycznego 1
    społeczno-gospodarczego. Ponadto nie podoba mi się taki tryb pracy Komisji.
    Oznacza on bowiem porzucenie całego dorobku pracy podkomisji i rozpoczęcie
    dyskusji od początku. Uważam również, że skrajna interpretacja następstw
    przyjętej formuły jest niezgodna z tym, co różni eksperci mówili podczas
    prac podkomisji. Proszę więc o wypowiedzi innych ekspertów, gdyż punkt
    widzenia przedstawiony przez prof. W. Osiatyńskiego wydaje się być skrajnym
    i jednostkowym. W szczególności zupełnie nie rozumiem tego poglądu, który
    stanowi, że można stworzyć gwarancje socjalne nie dopuszczając do
    redystrybucji. Tylko na podstawie redystrybucji, i to daleko idącej, można
    zapewnić elementy państwa socjalnego i tak to się dzieje w praktyce
    niemieckiej. Wydaje się, że między dwiema dyskutowanymi formułami różnica
    jest dość dyskusyjna. Dodam, iż nie byłem entuzjastą formuły znajdującej się
    w projekcie, ale zostałem przekonany argumentem, że urzeczywistnianie nie
    prowadzi natychmiast to rezultatu. Stwierdzenie, że Rzeczpospolita Polska
    jest państwem sprawiedliwości społecznej, byłoby formułą bardziej
    roszczeniową. Skoro jednak przywróciliśmy dyskusję globalną, to proszę, aby
    wypowiedzieli się również inni eksperci.
  </p>

  <!--<hr><p class="page-break">strona 14</p><hr>-->
  ...
  <p class="rep-statement">
    ...
    poglądów dotycząca wniosku posłów: J. Zdrady i T. Mazowieckiego. Przyjmujemy
    więc, że wniosek pierwszy został sformułowany. Wniosek drugi jest autorstwa
    posła J. Jaskierni. Korzystając z niepisanej zgody nieobecnego autora
    proponuję, aby ust. 1 brzmiał: „Rzeczpospolita Polska jest państwem
    suwerennym, jednolitym i niepodzielnym”. Pozostałe ustępy pozostają bez
    zmian.
  </p>
  <p class="rep-statement">
    <strong>Poseł Jerzy Ciemniewski (UW):</strong>
  ...
  <p class="rep-statement">
    ...
    identyczny z art. 4 projektu. Czy są uwagi do wniosku nr 3? Nie ma. Czy są
    uwagi do wniosku nr 4?
  </p>
  <p class="rep-statement">
    <strong>Senator Alicja Grześkowiak (NSZZ „S”):</strong>
  ...
  <p class="rep-statement">
    ...
    Polskie jest jednolite i niepodzielne”.
  </p>
  <p class="rep-statement">
    <strong>Poseł Aleksander Kwaśniewski (SLD):</strong>
  ...
  <p class="rep-statement">
    ...
    społecznej. Jest to idea utrwalona w Świadomości społecznej Polaków. Uważam
    więc, że zachowanie formuły o urzeczywistnianiu zasad sprawiedliwości
  ...
  <p class="rep-statement">
    ...
    sprawiedliwości obowiązuje: czy zasada „każdemu według pracy , czy „każdemu
    według potrzeb”?
  </p>
  <p class="rep-statement">
    <strong>Poseł Aleksander Kwaśniewski (SLD):</strong>
  ...
  <p class="rep-statement">
    <strong>Poseł Tadeusz Iwiński (SLD):</strong>
    W art. 4 mojego wniosku proponuję modyfikację części końcowej. Powinna ona
    brzmieć: „oraz zapewnia ochronę Środowiska kierując się zasadą
  ...
  <p class="rep-statement">
    ...
    wniosku nr 6 złożonego przez przedstawicieli Prezydenta RP, wniosek nr 7
    senatora S. Pastuszki oraz wniosek nr 8 senatora J. Orzechowskiego.
  </p>
  <p class="rep-statement">
    <strong>Senator Jerzy Madej (KD):</strong>
  ...
  <p class="rep-statement">
    <strong>Poseł Tadeusz Mazowiecki (UW):</strong>
    Widzę tę trudność głosowania, o której mówił poseł R. Bugaj. Nawiązując do
    wypowiedzi senatora J. Madeja, chcę zwrócić uwagę, że po przyjęciu
    określonej formuły art. | konieczne będzie rozważenie formuły art. 2, „w
    zależności od przyjętej treści art. 1. Jest to uwaga pierwsza. Uwaga druga.
    Spór o to, czy w konstytucji ma się znaleźć sformułowanie o republikańskiej
    formie państwa, był sporem dość formalnym i wynikał głównie z różnego
    pojmowania pojęcia: „Rzeczpospolita ”. Ponadto wydaje mi się, że bez
    dyskusji nie powinniśmy przesądzać sposobu sformułowania kwestii
    sprawiedliwości społecznej czy państwa socjalnego. Problem nie polega na
    tym, aby w ogóle nie podjąć kwestii działalności socjalnej państwa, lecz na
    tym, że przyjmując określoną formułę możemy przesądzić zakres zobowiązań
    państwa i to, kto będzie rozstrzygał tę kwestię. |
  </p>
  <p class="rep-statement">
    <strong>Poseł Aleksander Kwaśniewski (SLD):</strong>
    ...
    Konstytucji będzie miał brzmienie stwierdzające, że Rzeczpospolita Polska
  ...
  <p class="rep-statement">
    ...
    ,S”): Proszę wyjaśnić mi, na czym polega głosowanie, które właśnie się
  ...
  <!--<hr><p class="page-break">strona 16</p><hr>-->
  ...
  <p class="rep-statement">
    ...
    Komisji. Uważam również, że możliwe jest przeprowadzenie pełnego głosowania
    nad każdym zgłoszonym wnioskiem.
  </p>
  <p class="rep-statement">
    <strong>Senator Jerzy Madej (KD):</strong>
  ...
  <p class="rep-statement">
    ...
    państwie prawnym oraz o zasadzie sprawiedliwości społecznej. Rozstrzygnięcia
    wymaga natomiast rzeczywiście formuła dotycząca sprawiedliwości społecznej,
    a więc kwestia, którą podniósł senator J. Madej.
  </p>
  <p class="rep-statement">
    <strong>Senator Alicja Grześkowiak (NSZZ:</strong>
    „„S”): Z art. 10 regulaminu Komisji wnioskuję, że wszystkie zgłoszone
  ...
  <p class="rep-statement">
    ...
    procedurę zmierzającą do ustalenia ostatecznego brzmienia art. 1. W grę
    wchodzi brzmienie proponowane przez posła T. Iwińskiego, senatora H. Rota i
    moje oraz brzmienie proponowane przez posłów J. Zdradę oraz T.
    Mazowieckiego.
  </p>
  <p class="rep-statement">
    <strong>Senator Jerzy Madej (KD):</strong>
  ...
  <p class="rep-statement">
    <strong>Poseł Aleksander Kwaśniewski (SLD):</strong>
    Przechodzimy zatem do uszczegółowienia propozycji, która uzyskała poparcie
    20 członków Komisji. Do wyboru mamy dwie formuły, o których mówił poseł J.
    Szymański.
  </p>
  <p class="rep-statement">
    <strong>Przedstawiciel Prezydenta RP, prof. Andrzej Rzepliński:</strong>
  ...
  <p class="rep-statement">
    ...
    stawia nas w trochę dziwacznej sytuacji. Możemy głosować według wyboru
    językowego, a więc, który z tych dwóch wyrazów bardziej się podoba. Druga
    możliwość to kryterium głosowania, według którego ci, którzy chcą, aby
    państwo polskie było trochę bardziej społeczne, będą głosować za formułą
    mówiącą o urzeczywistnianiu. Ci, którzy chcą, aby państwo było trochę
    społeczne, będą głosować za formułą mówiącą o kierowaniu. Uważam, że oba
    kryteria są nonsensowne. Ja przed tym głosowaniem chciałbym mieć odpowiedź
    na zasadnicze pytanie, które zostało postawione przez prof. W. Osiatyńskiego
    jako swego rodzaju teza, Jedno z tych sformułowań, a może oba — i to nie
    jest dla mnie jasne — przesądzają o prawie Trybunału Konstytucyjnego do
    rozstrzygania o sposobie corocznego podziału środków przez państwo w ustawie
    budżetowej. Chcę wiedzieć w sposób kategoryczny, zdecydowany i kompetentny
    przed głosowaniem, czy którykolwiek z tych wyrazów wprowadzony do
    konstytucji rzeczywiście to oznacza, a jeżeli tak, to który wyraz to
    oznacza. Uważam, że bez rozstrzygnięcia tej kwestii stosownymi ekspertyzami,
  ...
  <p class="rep-statement">
    <strong>Ekspert Komisji, prof:</strong>
    Leszek Wiśniewski : Uważam, że pojęcie „państwo socjalne” nie zastępuje
    zwrotu: „państwo urzeczywistniające zasady sprawiedliwości społecznej”. W
    kontekście tego, co powiedział prof. W. Osiatyński, w przypadku państwa
    socjalnego chodzi o rozdział dóbr i wartości socjalne w ścisłym znaczeniu
    tego słowa. Urzeczywistnianie zasad sprawiedliwości społecznej dotyczy
    również innych kwestii, takich jak m.in. równomiermie obciążenie obywateli
    obowiązkami, traktowanie osób niepełnosprawnych, kobiet w pewnych
    sytuacjach, praw wyborczych. Tak więc zakres pojęcia urzeczywistniania zasad
    sprawiedliwości społecznej jest znacznie szerszy niż tylko rozdział dóbr i
    wartości socjalnych.
  </p>
  <p class="rep-statement">
    <strong>Senator Alicja Grześkowiak (NSZZ „S”):</strong>
    Proszę o wyraźne stanowisko w następującej kwestii: czy poprawki zgłoszone
    przez członków Komisji, zawarte w zestawieniu poprawek, które otrzymaliśmy,
    będą czy nie będą poddane pod głosowanie. Nie mogę zrozumieć, jaki jest sens
    zgłaszania poprawek, które nie są poddawane pod głosowanie. Widzę, że
    ustalanie brzmienia poszczególnych artykułów konstytucji ma miejsce teraz na
    sali. Wiem natomiast, że mamy prawo składania wniosków mniejszości, lecz
    jest to inna kwestia.
  </p>
  <p class="rep-statement">
    <strong>Poseł Aleksander Kwaśniewski (SLD):</strong>
    Chcę poinformować panią senator, że poprawki są głosowane. Jej poprawka
    dotycząca art. 1 została poddana głosowaniu w ramach głosowania kierunkowego
    nad trzema opcjami generalnymi brzmienia art. 1.
  </p>
  <p class="rep-statement">
    <strong>Senator Alicja Grześkowiak (NSZZ „S”):</strong>
    Już dość długo głosuję nad różnymi poprawkami, lecz nie rozumiem, co to
    znaczy, że głosowanie nad moją poprawką było kierunkowe. Proszę o precyzyjną
    odpowiedź, czy zgłoszone poprawki były poddane pod głosowanie, czy też nie.
  </p>
  <p class="rep-statement">
    <strong>Poseł Aleksander Kwaśniewski (SLD):</strong>
    ...
    wyniknie. Podobne opinie przedstawili poseł J. Szymański i senator J. Madej.
  </p>
  <p class="rep-statement">
    <strong>Poseł Jacek Taylor (UW):</strong>
    ...
    służyła skarga konstytucyjna — będzie przysługiwało roszczenie, które będzie
    mogło być dochodzone przy pewnej konkretyzacji żądania. Natomiast
    sformułowanie o kierowaniu się zasadami sprawiedliwości społecznej nie daje
    podstawy do'samodzielnego roszczenia. Jest to poniekąd tylko dyrektywa
    ogólna, która chyba nie jest wystarczająca, aby uznać ją za podstawę
    roszczenia.
  </p>
  <p class="rep-statement">
    <strong>Poseł Janusz Szymański (UP):</strong>
    ...
    ukształtowało się znacznie orzecznictwo Trybunału Konstytucyjnego dokonujące
    interpretacji tej zasady konstytucyjnej. Utrzymanie tej formuły może być
    uzasadnione tak samo, jak poseł J. Ciemniewski uzasadniał utrzymanie zasady
    państwa prawnego. Byłoby bowiem źle burzyć dotychczasowy stan orzecznictwa.
    Uważam, że gdybyśmy przyjęli zasadę państwa jako wspólnego dobra obywateli,
    to każda petycja do Trybunału Konstytucyjnego mogłaby czerpać swoje
    ...
    Były to sprawy dotyczące z reguły ubezpieczeń społecznych i innych kwestii
    dotyczących obywateli. Na tym gruncie ukształtowała się dosyć jasna linia
    orzecznictwa. Ponadto chcę dodać, że nie odnajduję wyraźnej dystynkcji
    między formułą mówiącą o urzeczywistnianiu zasady sprawiedliwości społecznej
    i formuły mówiącej o kierowaniu się zasadami sprawiedliwości społecznej.
    Myślę, że jest to dystynkcja tylko werbalna.
  </p>

  <!--<hr><p class="page-break">strona 18</p><hr>-->
  ...
  <p class="rep-statement">
    ...
    mówił poseł J. Szymański. Wydaje się, że pominięcie tego sformułowania
    byłoby znaczące, gdyż pojawiłby się nowy stan prawny, ponieważ poprzedni
    został przez ustawodawcę zakwestionowany. Ja nie chcę takiej zmiany. Jeżeli
    chodzi o interpretację, to warto pamiętać, że problemy interpretacyjne
    występują w bardzo wielu kwestiach. Jeżeli przyjmiemy sformułowanie, że
    państwo zapewnia ochronę środowiska przyrodniczego, to również pojawi się
    problem interpretacji, co to oznacza, że „zapewnia ”. Wydaje się również, że
    pojęcie państwa socjalnego jest być może bardziej ambitne, lecz wielką
    przestrzeń interpretacji dopiero musiałoby sobie stworzyć. Jest bowiem tak,
    że pojęcie „urzeczywistwyraża pewność, iż urzeczywistnianie następuje w
    miarę pewnych obiektywnych możliwości, a więc nie jest to natychmiast stan
    wymagalny, lecz pewien ruch i dążenie. Opowiadam się więc za utrzymaniem
  ...
  <p class="rep-statement">
    ...
    precyzujący pojęcie urzeczywistniania sprawiedliwoŚci społecznej. Uważam
    również, że nie można nam jako prawodawcy konstytucyjnemu odbierać prawa
    wytyczania kierunków ochrony praw obywatelskich w tzw. normach programowych,
    a z taką normą mamy do czynienia w tym przypadku. Warto również pamiętać, że
    normy tego rodzaju przybiorą konkretny roszczeniowy kształt dopiero w
    prawodawstwie zwykłym. Nie można więc utożsamiać zobowiązań wynikających z
    prawa publicznego ze zobowiązaniami wynikającymi z prawa cywilnego. W
  ...
  <p class="rep-statement">
    ...
    formuł nie ma żadnego znaczenia dla sposobu dochodzenia roszczeń obywateli,
    lecz nie roszczeń o charakterze cywilnoprawnym. Przy tej okazji muszę
    powiedzieć, że ze zdziwieniem przeczytałem wypowiedź rzecznika praw
    ...
    sprawiedliwości społecznej jest sformułowaniem znanym prawu konstytucyjnemu
    i polegającym na tzw. rozwojowym charakterze praw. W moim przekonaniu jest
    to istota niebezpieczeństwa, jakie rodzi to sformułowanie. Była taka teoria,
    aby z takiego sformułowania wyciągać, że każda następna ustawa musi
    poszerzać zakres praw w kierunku, który zmierza do jakiegoś ostatecznego
    celu, jakim jest sprawiedliwość społeczna. Chcę dodać, iż nie wiem zbyt
    dobrze, co to jest sprawiedliwość społeczna i gdzie jest kres tego procesu
    urzeczywistniania owej zasady sprawiedliwoŚci społecznej. Natomiast w
    przypadku przyięcia formuły o kierowaniu się zasadą sprawiedliwości
    społecznej, to jeszcze jestem w stanie zrozumieć, że chodzi o uwzględnienie
    pewnych rodzajów wartości zmierzających do wyrównywania różnic społecznych.
    Jeżeli natomiast mam zmierzać w kierunku jakiegoś idealnego stanu
    sprawiedliwości społecznej, to jest to dla mnie bardzo niebezpieczna droga.
    Co więcej, jeżeli ma to oznaczać, że jako ustawodawcy nie wolno mi się
    cofnąć na tej drodze, lecz mam zmierzać w kierunku bliżej nieokreślonego
    ideału, to zawahałbym się przed podniesieniem ręki w głosowaniu za takim
    sformułowaniem.
  </p>
  <p class="rep-statement">
    <strong>Poseł Ryszard Bugaj (UP):</strong>
    Ad vocem chcę powiedzieć o dwóch kwestiach dotyczących trybu dyskusji w
    związku z uwagą posła J. Ciemniewskiego. Posiedzenia Komisji Konstytucyjnej
    ZN orze Przypominam, że na poprzednim posiedzeniu dyskutowaliśmy główne
    dylematy. Wówczas jednak nikt nie podniósł tej kwestii jako główny dylemat.
    Również ku mojemu zdziwieniu z podkomisji nie wyszedł zapis wariantowy, mimo
    obecności przedstawicieli wszystkich tendencji politycznych. Wydawało się
    więc, że sprawa nie jest kontrowersyjna. Nie mam nic przeciwko temu, abyśmy
    powrócili do tej kwestii, lecz działałem w zaufaniu do pewnych
    wcześniejszych faktów. Proszę również zwrócić uwagę, że kiedy kwestię tę
    podniósł globalnie prof. W. Osiatyński, to zaproponowaliśmy powrót do
    dyskusji. Wówczas pan przewodniczący powiedział, że nie ma potrzeby 1
    wówczas nikt nie protestował. Jeżeli trzeba powr cić do dyskusji, to uczyńmy
    to, ale proszę nie stawiać zarzutu, że chcemy zamknąć dyskusję.
  </p>
  <p class="rep-statement">
    <strong>Poseł Aleksander Kwaśniewski (SLD):</strong>
  ...
  <p class="rep-statement">
    ...
    prawnego. Uważam ponadto, że zarówno jedna jak i druga dyskutowana formuła
    mają charakter kierunkowy. Moim zdaniem dopiero na tle orzecznictwa i
    powstałych sporów wynikających z bezpośredniego stosowania konstytucji może
    się ukształtować właściwy sens tej formuły. Natomiast my dzisiaj nie
    odpowiemy na wiele wyzwań i pytań konstytucyjnych bez rozstrzygnięcia
    katalogu praw socjalnych i ich gwarancji formalnych na przykład w formie
    skargi konstytucyjnej. Należy jednak dodać, że w dużej mierze będzie to
    zależało od charakteru i treści samej normy, a więc, czy będzie miała
    charakter samowykonawczy.
  </p>
  <p class="rep-statement">
    <strong>Senator Jerzy Madej (KD):</strong>
  ...
  <!--<hr><p class="page-break">strona 19</p><hr>-->

  <p class="rep-statement">
    <strong>Poseł Jan Rokita (UW):</strong>
    Odnosząc się do krytycznych pod moim adresem wypowiedzi posła R. Bugaja 1
    poseł K, Łybackiej, chcę powiedzieć, iż uważam, że zadaniem członka Komisji
    Konstytucyjnej nie jest studiowanie dorobku orzecznictwa Trybunału
    Konstytucyjnego, do czego namawiała mnie poseł K. Łybacka. Nie uważam
    również, aby fakt przeprowadzenia głębokiej dyskusji na posiedzeniu
    ...
    głosowaniem. Wydaje mi się, że pytanie o to, czy Trybunał Konstytucyjny przy
    sformułowaniu pierwszym 1 przy sformułowaniu drugim będzie mógł zmieniać
    podział Śśrodków budżetowych na mocy orzeczeń w trybie skargi konstytucyjnej
    obywateli, czy też nie, jest pytaniem dość kluczowym, na które odpowiedź
    członkowie Komisji Konstytucyjnej powinni otrzymać przed głosowaniem.
    ...
    jednoznaczna odpowiedź i zostanie przedstawiona przez posła R. Bugaja.
  </p>
  <p class="rep-statement">
    <strong>Ekspert Komisji, prof:</strong>
  ...
  <p>
    ...
    dopiero uchwalone prawo — a więc ustawa — decyduje o tym, jak sprawiedliwość
    została w nim wyrażona. Być może formuła „kieruje” jest lepsza, ale formuła
    „urzeczywistnia” w Świetle orzeczenia Trybunału Konstytucyjnego nie daje
    podstaw do obaw, które były wyrażane.
  </p>
  <p class="rep-statement">
    <strong>Poseł Aleksander Kwaśniewski (SLD):</strong>
  ...
  <p class="rep-statement">
    ...
    wszystkich dociera świadomość uprawnień Trybunału. Jednakże z chwilą, gdy
    Trybunał otrzyma prawo wydawania ostatecznych orzeczeń dotyczących zgodności
    z konstytucją, jego pozycja ustrojowa niepomiernie wzrośnie, zwłaszcza
    jeżeli obywatele uzyskają prawo składania indywidualnych skarg do Trybunału
    na naruszenie ich praw ujętych w konstytucji. Uważam, że formuła mówiąca o
    urzeczywistnianiu sprawiedliwości społecznej będzie stwarzać dużo problemów
    interpretacyjnych. Sądzę, że gdyby ta kompetencja miała być przypisana
    prezydentowi, to Komisja byłaby zapewne znacznie bardziej powściągliwa. Już
    wcześniej przytaczałem przykład Czech. Konstytucja Republiki Czeskiej nie
    określa państwa jako socjalnego, lecz poziom zabezpieczeń socjalnych, które
    są gwarantowane obywatelom przez państwo — za pomocą ustaw — jest bez
    porównania wyższy niż w Polsce. Inny przykład to Szwecja, której konstytucja
    nie wymienia praw socjalnych, a jest to państwo opiekuńcze. Tak więc kwestia
    dużej ostrożności będzie miała istotne znaczenie, gdyż możemy się znaleźć w
    sytuacji, w której Trybunał Konstytucyjny będzie sprawował władzę
    prawodawczą i władzę wykonawczą, gdyż będzie dokonywał redystrybucji dochodu
    narodowego, co powinno być w gestii wyłącznie władzy ustawodawczej i
    wykonawczej.
  </p>
  <p class="rep-statement">
    <strong>Ekspert Komisji, prof. Wiktor Osiatyński:</strong>
    ...
    trzy rodzaje sprawiedliwości: rozdzielczą, kumulatywną i proceduralną, Można
    jeszcze wymienić sprawiedliwość retrybutywną. Dwie, a może trzy z nich, są
    po prostu pojęciami sprawiedliwości, a nie sprawiedliwości społecznej.
    ...
    sprawiedliwości. W związku z tym chcę przypomnieć, że po roku 1987 pojęcie
    sprawiedliwości społecznej w Polsce odegrało ogromną pozytywną rolę,
    ponieważ w państwie nieprawnym stało się substytutem państwa prawa.
    Przypomnę, że w nowelizacji Konstytucji PRL w 1976 r. wprowadzona została
    formuła o sprawiedliwości społecznej. Następnie powstał urząd Rzecznika Praw
    Obywatelskich. W ustawie do21 tyczącej tego urzędu w art. 1 ust. 3 zapisano,
    że Rzecznik dba o zgodność ustaw z konstytucją, z zasadami współżycia
    społecznego I zasadami sprawiedliwości społecznej. Urząd Rzecznika został
    więc połączony z zasadą sprawiedliwości społecznej. Rzecznik często
    powoływał się na tę zasadę, nie mogąc powołać się ra inne zasady. Przykładem
    może być kwestia rewaloryzacji książeczek mieszkaniowych. W demokratycznym 1
    konstytucyjnym państwie prawnym obrona tych książeczek opierałaby się na
    zasadzie prawa własności. Podobnie było po 1989 r., kiedy to na skutek
    niedoskonałości konstytucji postępował tak również Trybunał Konstytucyjny.
    Jako obserwator pracy Trybunału mam nieco inną interpretację jego dzii
    orzeczeń niż prof. K. Działocha. Trybunał Konstytucyjny bardzo ostrożnie
    powoływał się na zasadę sprawiedliwości społecznej. Zasadę tę stosował wraz
    z innymi przepisami konstytucji. Przykładem może być art. 70, mówiący o
    prawie do ochrony zdrowia. Zasada ta w połączeniu z zasadą sprawiedliwości
    ...
    opublikowanej _— prof. L. Garlickiego, który wyraźnie przedstawił, że jeśli
    chcemy w przyszłości, w państwie prawnym i konstytucyjnym zapewnić to, aby
    Trybunał Konstytucyjny nie podejmował decyzji wpływających na kwestie
    budżetowe, wskazana byłaby rezygnacja z zasady sprawiedliwości społecznej w
    konstytucji. Jeżeli zasada ta pozostanie, to przy ostateczności orzeczeń
    Trybunału Konstytucyjnego będzie on mógł podejmować takie decyzje. Prof. K.
    Działocha podniósł kwestię skargi. Rzeczywiście jest kwestią do dyskusji,
    czy skarga obywatela może spowodować tego rodzaju roszczenie. Ponieważ w
    projekcie konstytucji nie ma skargi erga omnes, nie jest pewne, czy skarga
    konstytucyjna może spowodować roszczenia. Nie ulega natomiast wątpliwości,
    że Rzecznik Praw Obywatelskich powołując się w szczególności na art. 1 ust.
    3 ustawy o Rzeczniku Praw Obywatelskich, mówiącego o zasadzie
    sprawiedliwości społecznej, będzie mógł podważyć normę prawną — w tym
    również ustawę budżetową — z punktu widzenia jego interpretacji tej zasady.
    ...
    się zasadami sprawiedliwości społecznej. Nie podejmuje ona bowiem kwestii
    rozwojowego charakteru praw oraz nasuwa mniejsze podstawy do wysuwania
  ...
  <p class="rep-statement">
    <strong>Poseł Irena Lipowicz (UW):</strong>
    Skrócę moją wypowiedź, gdyż kilka kwestii podjął już prof. W. Osiatyński.
    Naszą intencją przy wyborze formuły mówiącej o kierowaniu się zasadami
    sprawiedliwości społecznej przez państwo było zbliżenie tego pojęcia do
    pojęcia państwa socjalnego, które — ku mojemu ubolewaniu — nie przyjęło się
    w naszej literaturze. Interpretacja nadawana w toku posiedzenia Komisji ma
    również znaczenie wyjaśniające. Jest kwestią bardzo ważną, abyśmy z jednej
    strony widzieli obowiązek ciążący na państwie i kierunek, w którym porusza
    się ustawodawca. Nie jest to jednak demokracja socjalistyczna, czy inne tego
    typu pojęcia. Jeżeli chodzi o treść tego pojęcia, to jest ono zbliżone do
    pojęcia państwa socjalnego. Pamiętajmy, że sprawiedliwość społeczna tak
    właśnie rozumiana występowała wśród haseł „Solidarności ”. Tak więc należy
  ...
  <p class="rep-statement">
    ...
    konstytucji z 1952 r. Oznaczałoby to przecież, że nie możemy na przykład
    posłużyć się kategorią suwerenności narodu. Jeżeli jest tak, że
    sformułowanie mówiące o urzeczywistnianiu sprawiedliwości społecznej może
    prowadzić do indywidualnej skargi konstytucyjnej, to chcę zapytać: czy
    brzmienie art. 3 projektu również może prowadzić do skargi konstytucyjnej?
    Słyszę odpowiedzi, że może być podstawą do skargi konstytucyjnej, a mimo to
    ...
    ustawodawcze. Jeżeli Trybunał Konstytucyjny stwierdza, że naruszono prawa
    słusznie nabyte, to być może wła nie na podstawie takiej normy. Musimy więc
    odpowiedzieć, czy chcemy mieć taką normę i taką potencjalną blokadę, czy też
    nie. Jeżeli bowiem zdarzy się rząd Unii Polityki Realnej, który postanowi
    zlikwidować renty i emerytury gwarantowane przez państwo, to chcę, aby była
    taka blokada. Jestem bowiem głęboko przeświadczony, że pewien poziom tych
    gwarancji jest także gwarancją dla demokracji i stabilności państwa
    polskiego. Taką przyjmuję filozofię i myślę, że jest to moje dobre prawo. Na
    tę filozofię można odpowiedzieć inną filozofią, a nie podważaniem strony
    formalnej mojej filozofii. Odnosząc się do wypowiedzi posła J. Rokity, nie
    mogę jednak nie powiedzieć, że zgodnie z ustawą o obowiązkach i prawach
    posłów i senatorów udział w pracach parlamentu jest nie tylko prawem, ale 1
    obowiązkiem posłów i senatorów. Jeżeli poseł J. Rokita nie wziął udziału w
    żadnym w 12 dotychczasowych posiedzeń podkomisji i nie przedstawił żadnego
  ...
  <p class="rep-statement">
    ...
    Powiedziałem tylko, że w przypadku skargi konstytucyjnej można się powoływać
    na zasady. Dodałem, że może to być trudne dla obywatela, lecz może być
    stosowane przez Rzecznika Praw Obywatelskich. Jeżeli chodzi o inny fragment
    wypowiedzi posła R. Bugaja, to chcę zwrócić uwagę, że i zasada mówiąca o
    kierowaniu, i zasada mówiąca o państwie socjalnym również zapewnią cele, o
    których mówił poseł R. Bugaj. Nawet rząd UPR nie będzie mógł naruszyć tych
    zasad. Nie rozpatrujemy bowiem kwestii całkowitego usunięcia zasady
  ...
  <p>
    ...
    przegłosowanie woli Komisji, a więc czy Komisja chce uzyskać efekt ustrojowy
    w postaci kontroli wydatków publicznych przez Trybunał Konstytucyjny, czy
    też nie. Jest to bowiem pytanie o ustrojowy fundament państwa. W tym
    kontekście pytanie o wyrazy jest pytaniem śmiesznym.
  </p>
  <p class="rep-statement">
    <strong>Poseł Aleksander Kwaśniewski (SLD):</strong>
  ...
  <p class="rep-statement">
    <strong>Ekspert Komisji, prof:</strong>
    Kazimierz Działocha: Chcę przypomnieć, że należy odnosić się do całości
    projektu, a zwłaszcza do rozdziału o sądach i trybunałach. W sposobie ujęcia
    ...
    przesądzać o wydatkach państwa. Jest to zabezpieczenie — w moim przekonaniu
    dyskusyjne — polegające na tym, że orzeczenia pociągające za sobą wydatki
    budżetowe nie będą miały charakteru ostatecznego. W tej części byłyby
    rozpatrywane przez Sejm.
  </p>
  <p class="rep-statement">
    <strong>Poseł Jan Rokita (UW):</strong>
    Nie wiem, jaki będzie pogląd Komisji, ale uważam, że rozważanie art. 171 w
    wersji II, a więc w wersji obszernej politycznej kontroli Sejmu nad
    orzeczeniami Trybunału Konstytucyjnego — będzie bezprzedmiotowe, jeżeli
    ponownie przyjmiemy regułę państwa prawnego jako regułę konstytucyjną. Tego
    typu interpretacje są więc dla mnie nie do przyjęcia. Chcę szukać takich
    rozwiązań, w których zasady konstytucyjne nie dadzą formalnych podstaw do
    skarg do Trybunału Konstytucyjnego. Chodzi o skargę tego typu, że na
    przykład w 1999 r. większość parlamentarna przeznaczyła za mało pieniędzy
    dla emerytów a za dużo na pomoc dla przedsiębiorstw, a jest to sprzeczne z
    zasadą sprawiedliwości społecznej. Tu poszukiwałbym gwarancji, a nie w
    rygorach politycznych dotyczących Trybunału Konstytucyjnego.
  </p>
  <p class="rep-statement">
    <strong>Poseł Ryszard Bugaj (UP):</strong>
  ...
  <p>
    ...
    Jeżeli jednak nie ma zgodności poglądów, to poszedłbym dalej niż idzie poseł
    J. Rokita. Mogłoby to polegać na przesądzeniu o tym, czy w konstytucji mają
    być jakiekolwiek elementy ukierunkowujące. Czy państwo zapewnia ochronę
    środowiska, czy strzeże kultury narodowej? Są to bowiem również formuły
    określające, jak państwo ma działać.
  </p>
  <p class="rep-statement">
    ...
    o to, aby nie było to możliwe, i w tym się różnimy.
  </p>
  <p class="rep-statement">
    <strong>Senator Jerzy Madej (KD):</strong>
    Poseł R. Bugaj daje przykład zapewnienia ochrony środowiska. Właśnie o to
    chodzi, gdyż w grę wchodzą sprawy bardzo konkretne. Przykładem może być
    sytuacja, w której do Polski napłynęły tysiące ton szkodliwych odpadów, a
    prokuratura nie może znaleźć winnych. Sprawiedliwość społeczna jest jednak
    nadal pojęciem bardzo szerokim i możliwe są różne interpretacje. Przypominam
    hasło mówiące o tym, że wszyscy mamy jednakowe żołądki.
  </p>
  <p class="rep-statement">
    <strong>Poseł Aleksander Kwaśniewski (SLD):</strong>
  ...
  <p class="rep-statement">
    <strong>Ekspert Komisji, prof:</strong>
    Kazimierz Działocha: Zaproponowana formuła kryje pewne niebezpieczeństwa i
    grozi sporem z zakresu filozofii prawa. Nie można w ten sposób prawa stawiać
    ponad sprawiedliwością. Sprawiedliwość ma być realizowana zawsze poprzez
    ustawę. Prawo należy stosować do jego granic, ale w pewnych sytuacjach, gdy
    ...
    konkretna norma dotycząca określonego prawa socjalnego, a nie ogólna norma
  ...
  <p class="rep-statement">
    ...
    przed chwilą kierował do prof. K. Działochy, a więc aby uzyskać pewną zgodną
    interpretację intencji Komisji, która znalazłaby się w protokole? Czy pan
    przewodniczący trwa przy tej myśli, czy też porzucił ją? Ja ją bardzo
    popieram.
  </p>
  <p class="rep-statement">
    <strong>Poseł Aleksander Kwaśniewski (SLD):</strong>
  ...
  <p class="rep-statement">
    ...
    demokratycznym państwem prawnym, urzeczywistniającym Zasady sprawiedliwości
    społecznej”. Stwierdzam, że w głosowaniu wniosek uzyskał poparcie 23
    członków Komisji. Poddaję pod głosowanie wniosek, aby art. 1 miał brzmienie:
    „Rzeczpospolita Polska jest demokratycznym państwem prawnym 1 socjalnym”.
    Stwierdzam, że w głosowaniu wniosek uzyskał poparcie 8 członków Komisji.
    Nikt się nie wstrzymał. Tak więc art. 1 uzyskał brzmienie: „Rzeczpospolita
    Polska jest demokratycznym państwem prawnym, urzeczywistniającym zasady
    sprawiedliwości społecznej”. Przechodzimy do dylematów związanych z art. 2.
    W oparciu o zgłoszone wnioski merytoryczne treść art. 2 może dotyczyć: po
    pierwsze — wspólnego dobra wszystkich obywateli, po drugie — jednolitości I
    niepodzielności, po trzecie — praw człowieka >strzeżenia niepodległości 1
    terytorium, dziedzictwa kultury, ochrony środowiska oraz zrównoważonego
    rozwoju, po czwarte — sprawowania władzy zwierzchniej przez naród. Ponadto
    zgłoszone zostały dwa dalsze wnioski, które proponuję przegłosować odrębnie.
    Jest to wniosek senator A. Grześkowiak, będący częścią pewnej całości
    opartej na innej filozofii konstytucji. Podobnie rzecz się ma z poprawką
    posła L. Moczulskiego. |
  </p>
  <p class="rep-statement">
    <strong>Senator Jerzy Madej (KD):</strong>
    Uważam, że należy odpowiedzieć na pytanie, czy w tekście konstytucji musi
    znaleźć się art. 4 projektu, mówiący o tym, że Rzeczpospolita Polska jest
    państwem jednolitym i niepodzielnym. Jeżeli tak, to powinien to być jeden z
    początkowych artykułów.
  </p>
  ...
  <p class="rep-statement">
    ...
    typowa dla konstytucjonalizmu francuskiego. . Fakt, że Polska jest państwem
    unitarnym, będzie wynikać z rozdziału o samorządzie terytorialnym.
  </p>
  <p class="rep-statement">
    <strong>Poseł Janusz Szymański (UP):</strong>
    Uważam, że skoro art. 1 formułuje zasady państwa prawnego, to konsekwencją
    przyjęcia tej konwencji powinno być to, że art. 2 powinien wyrażać zasadę
    zwierzchnictwa narodu.
  </p>
  <p class="rep-statement">
    <strong>Poseł Leszek Moczulski (KPN):</strong>
    Uważam, że powinien zostać ustalony pewien porządek,'w myśl zasady: od
    kwestii bardziej ogólnych do kwestii bardziej szczegółowych. Odmiennie jak
    pan przewodniczący uważam, że moja propozycja art. 2 mieści się w ogólnej
    konwencji. Inne kwestie są ujęte w dalszych artykułach. Tak jest na przykład
    z zasadą pochodzenia władzy wyrażoną w art. 4 mojej propozycji. W grę
    wchodzi więc pewien porządek logiczny. Uważam, że najpierw należy określić
    wspólnotowy charakter Rzeczypospolitej, rozwinięty w proponowanym art. 2,
    albo w ogóle zrezygnować z kwestii wspólnotowego określenia
    Rzeczypospolitej. Powinna to być kwestia pierwsza. Kolejnym elementem byłaby
    kwestia trwałości państwa. Następnie powinno być ujęte pochodzenie władzy.
    Odwrócenie tej kolejności nie byłoby logiczne. Proponuję więc rozpocząć od
    kwestii art. 2 z mojej propozycji.
  </p>
  <p class="rep-statement">
    <strong>Senator Jerzy Madej (KD):</strong>
    Popieram pogląd posła L. Moczulskiego, że art. 2 powinien dotyczyć państwa
    jako wspólnego dobra wszystkich obywateli.
  </p>
  <p class="rep-statement">
    <strong>Poseł Jerzy Zdrada (UW):</strong>
    W naszej propozycji norma o państwie jako dobru wspólnym była również jako
    art. 2. Uważamy, że jest to kolejność logiczna. Zasada zwierzchnictwa narodu
    powinna być w art. 3.
  </p>
  <p class="rep-statement">
    <strong>Poseł Aleksander Kwaśniewski (SLD):</strong>
    Gdyby poseł J. Szymański był gotów przyjąć tego rodzaju punkt widzenia, to
    moglibyśmy rozstrzygnąć tę kwestię, gdyż ja także uważam, że po określeniu
    podstawowych elementów ustrojowych w art. l, w art. 2 powinno znaleźć się
    określenie mówiące o państwie jako wspólnym dobru wszystkich obywateli.
    Następna powinna być norma o suwerenności.
  </p>
  <p class="rep-statement">
    <strong>Poseł Janusz Szymański (UP):</strong>
  ...
  <p class="rep-statement">
    <strong>Poseł Jerzy Zdrada (UW):</strong>
    Za formułą mówiącą o państwie jako wspólnym dobru wszystkich obywateli lub
    podobnie, opowiadają się poprawki: 1, 2, 4, 5,6, 7 18. Powinien to być
    odrębny artykuł i o to apeluję do wnioskodawców.
  </p>

  <!--<hr><p class="page-break">strona 26</p><hr>-->
  <p class="rep-statement">
    <strong>Poseł Janusz Szymański (UP):</strong>
    ...
    konstytucja, to ja jednak nie popieram tego poglądu. Jestem uparty 1
  ...
  <p class="rep-statement">
    ...
    Winczorek. Pojęcie to zawiera wielorakie konotacje filozoficzne, odnoszące
    się nie tylko do historii najnowszej II Rzeczypospolitej. Elementem, na
    który warto zwrócić uwagę, jest to, że w pojęciu dobra wspólnego ukryta jest
    również idea sprawiedliwości społecznej i to ujęta w sposób wolny od pewnych
    niejasności czy wadliwych zobowiązań, które może przynieść pojęcie
    sprawiedliwości społecznej definiowane według ujęć z ostatniego
    dziesięciolecia. Ponadto pojęcie dobra wspólnego zawiera w sobie próbę
    wyważenia relacji między prawem a obowiązkiem obywateli, o czym zapomina się
    w tej dyskusji. Podjęcie kwestii praw i obowiązków obywateli jest otwarciem
    drogi do budowy prawdziwie demokratycznego społeczeństwa. Proszę więc wziąć
    pod uwagę, że formuła ta zawiera bogate konotacje filozoficzne, których nie
    da się sprowadzić do pojęcia tylko politycznego.
  </p>
  <p class="rep-statement">
    <strong>Poseł Tadeusz Iwiński (SLD):</strong>
    ...
    podtrzymuję ją. Oznacza to również podtrzymanie wniosku o skreślenie w
    całości art. 2.
  </p>
  <p class="rep-statement">
    <strong>Poseł Aleksander Kwaśniewski (SLD):</strong>
    Uważam, że sprawa dojrzała do głosowania. Poddaję pod głosowanie wniosek o
    skreślenie art. 2 projektu, który brzmi: „Rzeczpospolita Polska jest
    wspólnym dobrem wszystkich obywateli”. Stwierdzam, że Komisja w głosowaniu,
    większoŚcią 17 głosów przeciwnych, przy 9 głosach popierających i 1
    wstrzymującym się, odrzuciła wniosek. Dodam, iż jedna osoba nie brała
    udziału w głosowaniu. Zamierzam poddać pod głosowanie wniosek o utrzymanie
    art. 2 projektu jako art. 2 konstytucji.
  </p>
  <p class="rep-statement">
    <strong>Ekspert Komisji, prof:</strong>
  ...
  <p class="rep-statement">
    ...
    podczas obrad Zgromadzenia Narodowego, lub w końcowej części prac Komisji.
  ...
  <p class="rep-statement">
    <strong>Poseł Jerzy Zdrada (UW):</strong>
    Moja wypowiedź dotyczy informacji posła T. Iwińskiego, iż obaj byliśmy za
    usunięciem artykułu mówiącego o państwie jako dobru wspólnym. Chcę wyjaśnić,
    iż ja wypowiadałem się tylko w kwestii kolejności artykułów i wspomniałem o
    art. 2, który w mojej koncepcji miał być art. 4. Nie byłem więc za
    usunięciem art. 2, lecz za inną kolejnością.
  </p>
  <p class="rep-statement">
    ...
    na posiedzenia komisji i podkomisji w toku posiedzeń Sejmu, jest co najmniej
    dyskusyjna. Jutro będzie musiało odbyć się posiedzenie podkomisji, w skład
    której wchodzi 5 członków Komisji Konstytucyjnej, dlatego że marszałek nie
    wyraził zgody na posiedzenie tej podkomisji w trakcie ostatniego posiedzenia
    Sejmu. Proszę, aby pan przewodniczący użył swoich wpływów na marszałka
    Sejmu, jeżeli chodzi o tę praktykę.
  </p>
  <p class="rep-statement">
    <strong>Poseł Aleksander Kwaśniewski (SLD):</strong>
