...
<div in:fly={{ y: 100, duration: 1000 }}>
  ...
  >
    ...
    <Utterance
      speaker="Poseł Ryszard Bugaj (UP)"
      imgPath="/images/kk-speakers/BugajRyszard.png"
      text="Otwieram drugie w dniu dzisiejszym posiedzenie podkomisji. Rozumiem,
      że nasza poprzednia dyskusja ujawniła dwie kwestie, które powinny sprzyjać
      ...
      „autonomia” nie są określeniami, do których można sporządzić jednoznaczną
      wykładnię semantyczną. Z drugiej strony — powstały pewne problemy w
      związku z omówionym projektem posła T. Mazowieckiego. Związane są one Z
      kwestią rozgraniczenia pojęcia „autonomia” i ze zwrotem „na podstawie
      umowy zawartej...'. Określenie to może być formułą bardzo wymagającą i
      przy splocie niekorzystnych okoliczności mogłoby prowadzić do impasu w
      uregulowaniach. Większe niebezpieczeństwo jest związane nie tyle z
      kościołami, co ze związkami wyznaniowymi. Proponowałbym skupić się nad
      tymi problemami. Można szukać możliwości zastąpienia określenia „rozdział”
      innym sformułowaniem, np. o odrębności struktur państwa i kościoła,
      chociaż — przyznaję — nie mam gotowej propozycji. Można szukać możliwości
      przyjęcia formuły o autonomii i mocno deklarować, że dotyczy ona funkcji
      religijnych i organizacyjnych kościoła oraz precyzować, że pełnienie przez
      kościoły szerszych funkcji społecznych tak roZumianą autonomią nie byłoby
    ...
    <Utterance
      speaker="Poseł Tadeusz Mazowiecki (UW)"
      imgPath="/images/kk-speakers/MazowieckiTadeusz.png"
      text="Nie uważam, że ust. 3 zawierający zwrot: „określa umowa
      międzynarodowa” obliguje państwo do jej zawarcia. Może wyjaśnimy sobie ten
    ...
    <Utterance
      speaker="Poseł Tadeusz Mazowiecki (UW)"
      imgPath="/images/kk-speakers/MazowieckiTadeusz.png"
      text="Rozumiejąc różne urazy historyczne i inne starałem się wyjść im
    ...
    <Utterance
      speaker="Ekspert Komisji, prof. Leszek Wiśniewski"
      imgPath="/images/kk-speakers/WisniewskiLeszek.png"
      text="Otrzymałem przed chwilą od prof. Z. Łyki projekt art. 15 w nowej
      wersji. Odpowiada on propozycji posła T. Mazowieckiego, z tym że dokonana
      ...
      przez wojsko, publiczne szpitale, szkoły itd., co byłoby nie do przyjęcia.
      Proponuję więc w tym ustępie zostawić tylko „władze publiczne”. „Ust. 2.
      Kościoły i związki wyznaniowe są równouprawnione. Ust. 3. Kościoły i
      związki wyznaniowe są oddzielone od państwa oraz korzystają z autonomii i
      niezależności w wykonywaniu swoich zadań. Ust. 4. Sytuację prawną
      kościołów i związków wyznamiowych określają ustawy uchwalone po
      porozumieniu się z ich właściwymi przedstawicielami, a w odniesieniu do
      Kościoła katolickiego również umowa międzynarodowa ze Stolicą Apostolską
      ratyfikowana na podstawie upoważnienia wyrażonego w ustawie. Ust. 5. W
      celu realizacji praw człowieka i potrzeb obywateli państwo współdziała z
      kościołami i związkami wyznaniowymi . Chyba w tej propozycji jest
    ...
    <Utterance
      ...
      text="Powinniśmy zachowywać się pragmatycznie. Zakładam, że wszyscy mamy
      wolę osiągnięcia porozumienia. Dlatego bądźmy bardziej powściągłiwi w
      poszukiwaniu nowych formuł i starajmy się raczej zawężać pole
      rozbieżności. Wychodząc z tego punktu widzenia uważam, że propozycja prof.
      Z. Łyki idzie w tym właśnie kierunku. Jest ona bardzo bliska temu, co
      mógłbym bez większych zastrzeżeń zaakceptować. Gdyby pozostali członkowie
      Komisji, a także przedstawiciele kościołów i związków wyznaniowych
      akceptowali przedstawiony projekt, to być może zbliżylibyśmy się do
      porozumienia. Posiedzenia podkomisji stałych Komisji Konstytucyjnej ZN
      Miałbym kilka uwag. W swoim projekcie, uwzględniając m.in. argumenty prof.
      ...
      być uregulowany w rozdziale dotyczącym praw ludzkich i obywatelskich.
      Sugerowałbym konsekwentnie zakończyć ten przepis na wyrazach „religijnych
      i światopoglądowych”. Po drugie, Świadomie opowiadałbym się za
      pozostawieniem w tym przepisie sformułowania: „władze i instytucje
      publiczne zachowują neutralność światopoglądową”. W moim przekonaniu
      neutralność Światopoglądowa wojska czy szpitala oznacza tylko i wyłącznie
      tyle, że wszyscy powinni być jednakowo traktowani. Neutralność wyraża się
      w tym, że mamy ordynariat polowy katolicki i prawosławny. Dopuszcza się
      możliwość wyznawania innych religii i ich praktykowania, nikogo nie zmusza
      ...
      4 pojawia się problem dyskutowany również przy propozycji posła T.
      Mazowieckiego. Sformułowanie, że stosunki czy sytuację prawną Kościoła
      katolickiego określa umowa międzynarodowa, zawiera nakaz adresowany do
      władz państwa polegający przynajmniej na podjęciu starań w celu zawarcia
      takiej umowy. Rozumiem, że nie jest to intencją posła T. Mazowieckiego, bo
      inaczej interpretuje on to sformułowanie. Można wprost o tym stwierdzić,
      posługując się tekstem przedstawionym przez prof. Z. Łykę. Widziałbym
      możliwość dokonania bardzo prostej operacji redakcyjnej polegającej na
      tym, że zdanie, z którego złożony jest ten przepis, rozbiłoby się na dwa
      zdania w brzmieniu: „Sytuację prawną kościołów i związków wyznaniowych
      ...
      konstytucji możliwość i podstawę do zawarcia takiej umowy międzynarodowej.
      Jednocześnie nie wpisujemy powinności, której zrealizowanie nie zależy
      wyłącznie od władz państwa polskiego. W poprzedniej fazie naszej dyskusji
      słusznie pytano, czy tego typu sformułowanie mogłoby być interpretowane
      jako powinność Stolicy Apostolskiej. Oczywiście że nie, ale wykonanie
    ...
    <Utterance
      ...
      Zachariasz Łyko"
      imgPath="/images/kk-speakers/LykoZachariasz.png"
      text="Chciałbym wyjaśnić, skąd wziął się dokument, który jest przedmiotem
    ...
    <Utterance
      speaker="Poseł Ryszard Bugaj (UP)"
      imgPath="/images/kk-speakers/BugajRyszard.png"
      text="Czy mam rozumieć, że ust. 3 w brzmieniu: „Kościoły i związki
      wyznaniowe są oddzielone od państwa” jest także przedmiotem konsensu?
    ...
    <Utterance
      speaker="Poseł Ryszard Bugaj (UP)"
      imgPath="/images/kk-speakers/BugajRyszard.png"
      text="Myślę, że znaleźliśmy się w nowej, korzystniejszej sytuacji, bo
    ...
    <Utterance
      ...
      text="Optowałbym przeciwko uwzględnieniu w przepisie instytucji
      publicznych. Sądzę, że zamiast wyjaśniać sytuację, tylko ją komplikujemy.
      Możliwe są różne interpretacje, dlatego uważam, że zobowiązanie bardzo
      różnych instytucji do określonych zachowań nie jest dobre. Władze można
      zobowiązać do takich zachowań. Słyszałem przed chwilą interpretację posła
    ...
    <Utterance
      speaker="Ekspert Komisji, prof. Piotr Winczorek"
      imgPath="/images/kk-speakers/WinczorekPiotr.png"
      text="Chciałbym poprzeć propozycję, żeby wykreślić z tego przepisu
      instytucje, ale nie ze względu na religijne prze konania. Jeżeli przyjąć,
      że instytucja jest instytutem naukowym, albo uniwersytetem, albo katedrą
      na uni wersytecie, gdzie jest szerzony pogląd filozoficzny, jest szkoła
      ...
      również o działające na niwie publicznej? Dlatego w tym przepisie powinno
      chodzić o władze publiczne, a nie o instytucje publiczne? Publiczność może
      się wyrażać również w działaniu na forum publicznym. W takiej sytuacji
      pojawiłby się problem, czy działanie na polu publicznym czyni instytucję
      publiczną, czy jest ona prywatna, ale działa na forum publicznym. Chyba że
      przyjmiemy, że chodzi o instytucje noszące w nazwie określenie państwowe,
    ...
    <Utterance
      ...
      text="Mam jedno zastrzeżenie dotyczące rozszerzenia przekonań również o
      ...
      sfery przekonań ideologicznych. Podzielam zastrzeżenia prof. P. Winczorka.
      Przepis w brzmieniu: „Władze i instytucje publiczne Rzeczypospolitej
      Polskiej zachowują neutralność w sprawie przekonań religijnych i
    ...
    <Utterance
      speaker="Poseł Tadeusz Mazowiecki (UW)"
      imgPath="/images/kk-speakers/MazowieckiTadeusz.png"
      text="Ta propozycja powstała jak gdyby na szkielecie mojego projektu.
      Uważam, że w ust. I powinny być wymienione władze publiczne, bez
      instytucji. Argumenty już zostały przedstawione. Zachowałbym wyraz
      „ideologicznych”, ponieważ neutralność wobec spraw ideologicznych jest
      potrzebą bardzo Świeżą. Może by konstytucja demokratycznego państwa to
      uszanowała. Pani <strong>poseł podała przykład nacjonalistycznych
      i</strong> faszystowskich ideologii. Uważam, że będą one zakazywane z
      innych artykułów. BÓR O O Z, A 0 A m 4 REA CZ. A EWC AAAA EA. Jeśli ust. 3
      miałby być w takiej wersji, jak to zostało przedstawione w nowej
      propozycji, to należałoby się zastanowić nad tym, czy kościoły korzystają,
      czy są oddzielone od państwa oraz autonomiczne i niezależne w wykonywaniu
      swoich zadań. Proponowałbym jako ust. 4 zamieścić ust. 5. Mówi się tutaj o
      oddzieleniu, ale i o współdziałaniu. Ust. 4 można rozbić na dwa, zgodnie z
      poprzednią propozycją: „Stosunki między państwem a Kościołem katolickim
      określa umowa międzynarodowa zawarta ze Stolicą Apostolską i ustawy”. Jest
      jeden podmiot prawa mię- dzynarodowego i nie ma co udawać, że są inne.
      „Stosunek państwa do innych kościołów oraz związków wyznaniowych określają
      ustawy uchwalone na podstawie porozumienia zawartego przez rząd z ich
      właściwymi przedstawicielami”. Nie mogę zgodzić się z propozycją posła W.
      Cimoszewicza, bo przy takiej interpretacji następuje odwrócenie problemów.
      Cały czas dyskutowaliśmy o tym, aby sytuacja innych kościołów była
      równouprawniona i zmierzała do takiej samej sytuacji, w jakiej jest
      ...
      kościołem. Przy interpretacji nadanej przez posła W. Cimoszewicza sytuacja
      jest odwrócona. Byłoby zobowiązanie do porozumienia z innymi Kościołami,
      natomiast żadnego zobowiązania w stosunku do Kościoła katolickiego.
      Określenie „może być” użyte jest tylko w stosunku do Kościoła katolickiego
      i konkordatu, jeśli dobrze to zrozumiałem. Przedstawiciel Sekretariatu
      Konferencji Episkopatu Polski, ks. prof. Józef Krukowski: W dużej mierze
      podzielam poglądy zawarte w najnowszym projekcie z korektami posła T.
      Mazowieckiego i prof. L. Wiśniewskiego. Sądzę, że za szerokie jest
      rozumienie pojęcia „władze publiczne”. W związku z wypowiedzią poseł K.
      Łybackiej trzeba uświadomić sobie, że nie chodzi o zachowania, tylko o
      przekonania. Mogą być zachowania niezgodne z porządkiem moralnym i
      publicznym i wtedy władze nie będą wobec nich neutralne. Przepis mówi o
      przekonaniach religijnych i światopoglądowych. Neutralność może być
      pozytywna i negatywna. Zakładamy, że tutaj chodzi o neutralność pozytywną,
      a nie negatywną. Ważny jest ust. 2, który stwierdza, że kościoły i związki
      wyznaniowe są równouprawnione. Nie ma kościoła uprzywilejowanego. Kościół
      katolicki w żadnym wypadku nie ma takich roszczeń, bo uprzywilejowana
      pozycja wskazywałaby na nadanie państwu charakteru wyznaniowego. Z całą
      pewnością przedstawiciele Kościoła katolickiego nie chcą państwa
      wyznaniowego, dlatego jest tutaj poparta ta radykalna zasada. „Kościoły i
      związki wyznaniowe są oddzielone od państwa oraz autonomiczne i niezależne
      w wykonywaniu swoich zadań”. Sądzę, że byłoby to małżeństwo dwóch
      propozycji: oddzielenia oraz poszanowa Posiedzenia podkomisji stałych
      ...
      Każda instytucja, w tym wypadku kościół i państwo, ma swoje zadania. Niech
      ona te zadania realizuje. Trudno definiować, co należy do zadań państwa, a
      co do zadań kościoła, bo to wynika z natury każdej społeczności. „Sytuację
      prawną kościołów i związków wyznaniowych określają ustawy uchwalone po
      porozumieniu się z ich właściwymi przedstawicielami . Ta propozycja bez
      zastrzeżeń zasługuje na przyjęcie. „Sytuację prawną Kościoła katolickiego
      określa również umowa międzynarodowa ze Stolicą Apostolską”. Jeżeli
      przyjmiemy równość kościołów, jak to było powiedziane, to taką samą
      formułę trzeba przyjąć w sprawie regulacji wzajemnych stosunków.
      Oczywiście że sytuację prawną Kościoła katolickiego regulują też ustawy,
      ale istnieje możliwość, nie tylko możliwość, bo w państwach europejskich
      przyjęta jest metoda określania tych stosunków w konkordacie, zawarcia
      umowy międzynarodowej. Nie sądzę, żeby stawiało to inne kościoły w gorszej
      sytuacji, bo chodzi tutaj o poszanowanie każdego zgodnie z tym, kim jest.
      Tylko Kościół katolicki cieszy się podmiotowością publicznoprawną.
      Wpisywanie umowy międzynarodowej tylko jako hipotezy do konstytucji trochę
      dyskryminuje instytucję, która jest w Polsce od ponad tysiąca lat. Dlatego
      jestem za propozycją posła T. Mazowieckiego, który uważa, że należy
      przyjąć formułę, iż stosunek państwa do Kościoła katolickiego określa
      umowa międzynarodowa ze Stolicą Apostolską ratyfikowana na podstawie
    ...
    <Utterance
      speaker="Poseł Włodzimierz Cimoszewicz (SLD)"
      imgPath="/images/kk-speakers/CimoszewiczWlodzimierz.png"
      text="Miałem w pewnym momencie nadzieję, że jesteśmy bliżsi porozumieniu,
      a w tej chwili znowu pojawiają się wątpliwości. Będę starał się nie
      ...
      równość praw obywatelskich powinny zachowywać neutralnośćw tych sprawach.
      Dlatego trudno mi się zgodzić na usunięcie sformułowania, które znalazło
      się w uzgodnionej propozycji przedstawicieli kościołów. Być może, pojęcie
      „instytucje publiczne” wymaga doprecyzowania. Nie chodzi o upieranie się
      przy konkretnym określeniu, ale na pewno ograniczenie się do władz
      publicznych nie wyczerpuje problemu, jeśli Świadomie pomniejszymy zakres
      owej powinności zachowania neutralności Światopoglądowej. Rozumiem, że
      ust. 2 nie budzi żadnych zastrzeżeń. Propozycja przeniesienia tego, co
      jest w ust. 5 do ust. 4 jest słuszna i będzie miała pewne znaczenie w
      interpretowaniu tego, co będzie zawarte w ust. 3. Na razie świadomie
      pomijam analizę ust. 3. Jeśli chodzi o ustęp 4, to nie mogę przyjąć
      argumentacji posła T. Mazowieckiego, według której moja propozycja ma
      dyskryminować Kościół katolicki. Nie dostrzegam podstaw do takiego
      stwierdzenia. Pierwsze zdanie w brzmieniu: „Sytuację prawną kościołów i
      związków wyznaniowych określają ustawy uchwalone po porozumieniu się z ich
      właściwymi przedstawicielami” dotyczy wszystkich kościołów ti związków
      wyznaniowych. Nie ma więc żadnego elementu dyskryminującego. Gdyby nawet
      doszło do takiej sytuacji, w której stosunki z Kościołem katolickim nie
      byłyby uregulowane umową międzynarodową, to byłyby określone ustawą po
      ...
      również regulowana przez umowę międzynarodową” jedynie poszerza możliwości
      tej regulacji. W żadnym wypadku nie jest to wyraz dyskryminowania, wręcz
      przeciwnie, zgoda na tego typu sformułowanie oznacza wprowadzenie do
      konstytucji specjalnego przepisu dotyczącego uregulowania sytuacji prawnej
      Kościoła katolickiego, wymienionego tutaj z nazwy. Tak naprawdę chodzi o
      to, jak interpretujemy wyrazy: „może określać i „określa”. W moim
      przekonaniu wyraz „określa” oznacza powinność zawarcia takiej umowy
      międzynarodowej. Wyrażam wątpliWość, czy takie powinnościowe sformułowanie
      jest prawidłowe. Właściwsze jest określenie dopuszczające czy sugerujące
      taką możliwość. W ust. 3 problem wiąże się z formułą: „wykonywania swoich
      zadań”. Pozostawałbym przy tym, co proponowałem i co było również zawarte
      w in | NN EE ET A OE YO Z A Z nych projektach, a więc przy sformułowaniu o
      wykonywaniu funkcji religijnych i organizacyjnych. W czasie wcześniejszej
      fazy naszej dyskusji m.in. eksperci podnosili zastrzeżenia, co będzie,
      jeśli proboszcz organizuje kółko sportowe. W moim przekonaniu to się w
      sposób oczywisty mieści i daje zinterpretować na tle zasady współdziałania
    ...
    <Utterance
      speaker="Senator Krzysztof Kozłowski (KD)"
      imgPath="/images/kk-speakers/KozlowskiKrzysztof.png"
      text="Nawiązując do ostatnich słów posła W. Cimoszewicza, które trafiają
      mi do przekonania, stanowczo oponuję przeciw zamieszczeniu w tym przepisie
      ...
      nie razi ani nie przeszkadza ten wyraz i sądzę, że w odczuciu innych osób
      jest podobnie. Nie wyraz „oddzielone” tylko zwrot „od państwa” wywołuje
      wątpliwości. Konstytucja w art. 1 głosi, że państwo polskie jest
      Rzecząpospolitą. Oddzielenie od Rzeczypospolitej jest niepokojącym
    ...
    <Utterance
      speaker="Poseł Krystyna Łybacka (SLD)"
      imgPath="/images/kk-speakers/LybackaKrystyna.png"
      text="Wracam do ust. 1. Uważam, że instytucje publiczne muszą mieć
      zagwarantowaną neutralność w sprawach religijnych i światopoglądowych. Nie
      upieram się, aczkolwiek nadal twierdzę, że sprawa wolności przekonań
      ...
      uregulowana w art. 15 odnoszącym się do stosunków państwo-kościół. Ust. 4
      dotyczy sytuacji prawnej kościołów i związków wyznaniowych. Sformułowanie
      w ostatnim tekście obliguje do zawarcia umowy konkordatowej. Propozycja
      posła W. Cimoszewicza dopuszcza taką możliwość, tzn. nie wyklucza zawarcia
      konkordatu, natomiast tego nie nakazuje. JĄ W celu argumentacji chcę się
      posłużyć przykładem konstytucji Hiszpanii, kraju na wskroś katolickiego,
      który zawarł konkordat. Proszę posłuchać, jak brzmią przepisy konstytucji
      Hiszpanii dotyczące stosunków państwo—kościół. „Ust. 1. Zapewnia się
      jednostkom i wspólnotom wolność w sferze ideologii, religii i kultu.
      Korzystanie z tych wolności podlega tylko takim ograniczeniom, jakie są
      konieczne dla utrzymania ładu publicznego chronionego przez ustawę. Ust.
      2. Nikt nie może być zobowiązany do składania oświadczeń co do swej
      ideologii, religii lub swych przekonań. Ust. 3. Żadne wyznanie nie ma
      charakteru państwowego. Władze publiczne uwzględniają przekonania
      religijne społeczeństwa hiszpańskiego i utrzymują wynikające z tego
      stosunki współpracy z Kościołem katolickim i pozostałymi wyznaniami”. Nie
    ...
    <Utterance
      speaker="Poseł Ryszard Bugaj (UP)"
      imgPath="/images/kk-speakers/BugajRyszard.png"
      text="Mamy szansę na dokonanie przełomu i osiągnięcie porozumienia.
      Nawoływałbym do poszukiwania pragmatycznego wyjścia z różnych sytuacji. W
      ust. 1 są potencjalne dwie pułapki. Nie powiem, żebym wiedział, jak z nich
      wyjść, ale chciałbym je przedstawić. Z, jednej strony boję się trochę
      sformułowania, które mówi o instytucjach publicznych, bo nie chciałbym
      przy pomocy tego przepisu zamknąć drogi np. wykładowcom filozofii na
      uniwersytetach do głoszenia doktryn religijnych. Z drugiej strony nie
      chciałbym także, by po skreśleniu wyrazu „instytucje” okazało się, że np.
      struktury obronne, które zawsze działają według przymusu i dyscypliny,
      funkcjonowały doktrynalnie, nie były światopoglądowo neutralne i wymuszały
      na młodych ludziach uczestnictwo w ceremoniach religijnych. To są dwie
      skrajności, których powinniśmy uniknąć. Apelowałbym do poszukiwania
      formuły, która mogłaby zrealizować ten postulat. Sądzę, że nie należy się
      bać określenia „ideologicznych”, bo rzeczywiście jest tak, że
      zabezpieczenie przed działaniami inspirowanymi ideologicznie znajduje się
      w innych częściach konstytucji. Sugerował- bym to pozostawić. Posiedzenia
      podkomisji stałych Komisji Konstytucyjnej ZN mm „r Do ust. 2 nie mam uwag.
      Przy omawianiu ust. 3 chciałbym poddać pod rozwagę następującą propozycję.
      Prof. P. Winczorek wymyślił określenie, które wcześniej było przedmiotem
      ostrego sporu, to znaczy „oddzielone”. Możemy tutaj użyć sformułowania, że
      kościoły i związki wyznaniowe są odrębne od państwa. Jednocześnie można
      zaakceptować sugestię posła W. Cimoszewicza, że są autonomiczne i
      niezależne w wykonywaniu swych zadań religijnych. Może taką propozycję
      moglibyśmy wspólnie zaakceptować. W ust. 4 szukałbym kompromisu
      polegającego na tym, żeby przyjąć wniosek posła T. Mazowieckiego w sprawie
      wyodrębnienia ustępu dotyczącego Kościoła katolickiego, mówiącego zarówno
      o ustawach, jak i o konkordacie, o umowie międzynarodowej. Osobny ustęp
      ...
      Zrobilibyśmy również skromny ukłon historyczny. Pozostaje poważny problem,
      którym nadal jestem zatroskany. Nie boję się formuły „po porozumieniu”,
      jeśli chodzi o główne kościoły i związki wyznaniowe. Nasze uregulowania są
      i powinny pozostać liberalne. Oznacza to, że na marginesach mogą powstać
      patologie i wtedy formuła „po uzgodnieniu” może stać się przyczyną różnych
      konfliktów i zahamowania uregulowań prawnych. Apelowałbym o znalezienie
      przepisu bardziej „miękkiego” lub zawierającego wyjątek. Propozycja
      przedłożona przez przedstawicieli prezydenta jest przykładem tego typu
      poszukiwań, chociaż nie jest fortunna pod względem językowym.
      Przedstawiciel Polskiego Autokefalicznego Kościoła Prawosławnego, ks. bp
      Jeremiasz: Wiele z moich obaw przedstawił pan przewodniczący. Jest pułapka
      w przypadku instytucji publicznych, o której nie myślałem. Chrześcijańska
      Akademia Teologiczna i Akademia Teologii Katolickiej są instytucjami pań-
      ...
      zagrożeniem dla porządku publicznego. Taki problem jest w Niemczech, gdzie
      obowiązuje cała procedura uznania danego związku wyznaniowego. Jeżeli
      przepisy prawne są bardzo liberalne i musi automatycznie być uznany każdy
      związek wyznaniowy, to mogą powstać duże zagrożenia dla państwa. Można
      wprowadzić jakąś kategorię ograniczającą, np. zwrot: „sytuację prawną
      kościołów i związków wyznaniowych uznanych przez państwo”. Element
      porozumienia musi pozostać, bo nie można decydować o kimś bez
      zainteresowanego. Nie Podkomisja podstaw ustroju politycznego...
      (22.02.1995 r. — 14) 95 wiem, czy konstytucja musi określać tok uznaniowy.
      Może jest to pytanie pod adresem ekspertów. Przedstawiciel pełnomocnika
      obywatelskiego projektu konstytucji, Michał Drozdek: Bardzo dziękuję pani
      <strong>poseł za przytoczenie fragmentu konstytucji</strong> hiszpańskiej.
      Co prawda, nie akcentowałbym katolickości Hiszpanii, co socjalistyczny
      parlament, który uchwalał konstytucję. Nie ma w niej żadnych przepisów o
      potrzebie neutralności Światopoglądowej, o oddzieleniu kościoła od
      państwa. Wprost przeciwnie, władze publiczne uwzględniają przekonania
      religijne swoich obywateli. Sądzę, że jest to słuszna filozofia. Władze
      publiczne powinny być na usługach swoich obywateli, bo taka jest filozofia
      państwa demokratycznego. Nie są one osobnym podmiotem, drugą stroną
      barykady w stosunku do własnych obywateli, bo są instytucjami tych
      obywateli. W związku z tym uwzględniają ich potrzeby i Światopogląd.
      Władze nie muszą się bać tych poglądów i oddzielać się od obywateli. W tym
      kontekście wydaje mi się, że ust. 1 jest niepotrzebny. Dlatego w projekcie
      obywatelskim on się nie znalazł. Przepis ten ma bronić wolności sumienia
      mniejszości przed ewentualną zaborczością ze strony większości, która
      chciałaby nadużyć instytucje państwa. Do tego są wszystkie artykuły
      ...
      Akademia Teologiczna. Mnóstwo innych inicjatyw może być wspieranych przez
      demokratyczne państwo, bo są dobre, nie zagrażają obywatelom, niczyim
      prawom. Państwo ma wspierać rzeczy dobre, a nie można zakładać, że religia
      jest zła, Światopogląd obywateli jest zły i państwo nie może tego
      wspierać. Religia i humanizm, niekoniecznie religijny, bo nawet
      ateistyczny niosą wartości dla obywateli i państwo może wspierać tego typu
      motywacje. Nie zamykajmy tego przepisem o neutralności instytucji
      ...
      obywateli, bo do tego one służą przy zachowaniu praw człowieka, Co prawda
      wojsko nie jest wyliczane w klasycznych definicjach ani jako władza
      ustawodawcza, ani wykonawcza, ani sądownicza. Jednak przymus stosowany
      przez wojsko jest przymusem władzy pańStwowej, a nie stosowanym przez
      instytucję państwową. Zagrożenie dla wolności sumienia jest tam, gdzie
      pojawia się przymus. Jest on stosowany przez pań- | me M M — „ aan stwo w
      swoich instytucjach na zasadzie władzy państwowej. Pozostawienie w
      przepisie władz publicznych bez instytucji załatwia sprawę obrony wolności
      sumienia, Jeżeli w wojsku pojawia się zagrożenie dla wolności sumienia, to
      na zasadzie nadużywanego przymusu władzy państwowej, do czego nie można
      dopuścić. Nie można również dopuścić do sytuacji odwrotnej, w której
      obywatele służący dla dobra ojczyzny mieliby ograniczone prawa
      obywatelskie dotyczące wolności sumienia i nie mieliby możliwości
      korzystania z posługi duszpasterskiej. Myślę, że co do tego jest absolutna
      zgoda. Wyrażam duże zastrzeżenia do sformułowania dotyczącego problemu
      oddzielenia kościoła od państwa. Ono może być niejasne, różnie
      interpretowane i wywoływać kontrowersje, jak powiedział poseł W.
      Cimoszewicz. To sformułowanie może być nadużywane w celu wyeliminowania z
      życia publicznego, z życia państwowego wpływów religii, jak mamy to w
      projekcie Parlamentarnej Grupy Kobiet, zgodnie z którym z motywacji
      religijnych nie można tworzyć prawa. Tego rodzaju interpretacja w sposób
      drastyczny naraża na niebezpieczeństwo olność sumienia i samą ideę
      demokratycznego państwa, w którym każdy współkształtuje to państwo z
      motywacjł takich, jakie posiada, ale pod warunkiem, że są to motywacje nie
      zagrażające prawom innych obywateli. Nie da się oddzielić kościołów od
      państwa, dlatego że kościoły współstanowią to państwo. Słusznie zwrócono
      ...
      to przepis absurdalny i niezrozumiały. Dlatego opowiadałbym się za
      ...
      przysługiwało. W sprawie konkordatu nie ma chyba niepokoju, a jeśli jest,
      to nie wiem, skąd się on bierze, skoro nigdy w historii nie zdarzyło się
      tak, żeby Stolica Apostolska nie chciała zawrzeć konkordatu. Może nie znam
      dobrze historii prawa i ks. J. Krukowski zechce to sprostować. Stolica
      Apostolska w takim trybie załatwia umowy międzypaństwowe. Myślę, że na tej
      sali nie ma osób przeciwnych zawarciu konkordatu, a są tylko osoby, które
    ...
    <Utterance
      speaker="Poseł Ryszard Bugaj (UP)"
      imgPath="/images/kk-speakers/BugajRyszard.png"
      text="Rzeczywiście spór nie toczy się o to, czy dopuszczamy zawarcie
      ...
      międzynarodowa będzie entuzjastycznie ratyfikowana przez wszystkich. Przed
      tym problemem właśnie stoimy. Nakłaniałbym państwa do tego, żeby
      wypowiedzi nie były ogólne, ponieważ powinniśmy zbliżać się do określonej
      formuły, wokół której mielibyśmy szansę osiągnąć konsens, bo po to się
      zebraliśmy. Przedstawiciel Kościoła Zborów Chrystusowych, ks. Henryk
      Sacewicz: Chciałbym wrócić do kilku wątków poruszonych w dyskusji.
      Wyrażano obawy w sprawie ujęcia w przepisach instytucji. Padła sugestia,
      żeby wprowadzić pojęcie służby. Mój przedmówca wspomniał o rozumieniu
      wojska jako władzy państwowej. Mam prośbę do osób decydujących o tekście,
      by szpitale, szkoły i wojsko znalazły właściwe określenie, które
      zapewniałoby neutralność tych instytucji. W moim rozumieniu neutralność
      nie oznacza, że w tych instytucjach nie mogą być prezentowane różne
      postawy. Chodzi o to, żeby nie były one narzucane. Każda osoba znajdująca
      się w tej instytucji powinna mieć zapewnione prawo wyboru i w tym sensie
      mówimy o neutralności. Przyznam się szczerze, że jestem zaskoczony reakcją
      państwa na ust. 3. Tekst, nad którym pracujemy był redagowany m.in. przez
      ks. prof. J. Krukowskiego. Nie miał on zastrzeżeń do użycia w ust. 3
      określenia „oddzielone od państwa”, oczywiście złagodzonego dodatkowymi
      elementami znajdującymi się w zwrocie: „oraz korzystają z autonomii i
      niezależności . Jestem zaskoczony, że niektórzy z państwa mają w tej
      sprawie zastrzeżenia. Czyżby państwo byli bardziej papiescy niż sam
      papież? Słuszna była propozycja przesunięcia ust. 5 z powodu potrzeby
      zapewnienia ciągłości myśli zawartych w tym artykule. W sprawie
      dotychczasowego ust. 4 zarysowały się dwa stanowiska. Pojawiły się głosy
      optujące za podzieleniem tego ustępu na dwa. W jednym regulowane byłyby
      sprawy Kościoła katolickiego, a w drugim innych kościołów i związków
      ...
      katolickiego, tylko o to, że od elementów ogólniejszych przechodzi się do
      bardziej szczegóło wych. Ujęcie w jednym ustępie wszystkich tych problemów
      wynika z brzmienia ust. 2. Jeżeli mówi się o równouprawnieniu wyznań, to
      wszystkie regulacje prawne dotyczące kościołów zawieramy w jednym punkcie.
      Umieszczenie w ustępie rozwiązania charakterystycznego dla Kościoła
      katolickiego jest swego rodzaju uprzywilejowaniem tego kościoła. Słusznie
      poseł K. Łybacka powiedziała, że można by tego w ogóle nie zapisywać, a i
      tak z charakteru Kościoła katolickiego i zasad ogólnie przyjętych wynika,
      ...
      nie nakaz dla każdej ze stron. Rozumiem, że pojęcie „po porozumieniu”
      zawiera w sobie niebezpieczeństwa, na które wskazano w dyskusji. Może być
      jakiś związek religijny, który stwarzałby niebezpieczeństwa dla innych
      ludzi. Z takim związkiem nie byłoby porozumienia, a więc nie uzyskałby on
    ...
    <Utterance
      speaker="Poseł Ryszard Bugaj (UP)"
      imgPath="/images/kk-speakers/BugajRyszard.png"
      text="Zachęcałbym dyskutantów do zwięzłych wypowiedzi. Przedstawiciel
      Polskiego Autokefalicznego Kościoła Prawosławnego, ks. bp Jeremiasz:
      Chciałbym bronić ust. 3 w obecnym kształcie, bo jest on wynikiem uzgodnień
      w gronie przedstawicieli kościołów oraz — jak mi się wydawało — również w
      podkomisji i Komisji Konstytucyjnej. Istnieje komplementarność między
    ...
    <Utterance
      speaker="Poseł Włodzimierz Cimoszewicz (SLD)"
      imgPath="/images/kk-speakers/CimoszewiczWlodzimierz.png"
      text="Przed paroma godzinami zgłosiłem wersję tego przepisu, poszukując
      formuły, która godziłaby możliwie najwięcej propozycji zawartych w różnych
      projektach. Wszystkie ustępy występują w propozycjach wcześ- niej
      zgłoszonych. Dlatego uważałem, że będzie to w miarę szczęśliwe wyjście z
      sytuacji. Możemy osiągnąć pozytywny rezultat naszych prac w postaci
      uzgodnionego stanowiska tylko i wyłącznie wtedy, kiedy będziemy
      dyskutowali na podstawie merytorycznych argumentów, przy założeniu, że
      wszyscy chcą osiągnąć porozumienie i gotowi są na kompromis. Z tego powodu
      niektóre wypowiedzi w tej dyskusji muszę uznać za swoiste nieporozumienie,
      ...
      to jest to nieporozumienie. Jeżeli w wypowie dzi przedstawiciela
      obywatelskiego projektu w sposób zasadniczy dyskwalifikuje się
      sformułowania za Podkomisja podstaw ustroju politycznego... (22.02.1995 r.
      — 14) 97 warte m.in. w ust. 1 mówiące o neutralności, to nie na tym etapie
      dyskusji. Chciałbym do ust. 1 zaproponować poprawkę, która być może
      wyjdzie naprzeciw oczekiwaniom czy obawom różnych osób. Zwracam uwagę, że
      dotychczasowa wersja o instytucjach publicznych została przedstawiona w
      projekcie uzgodnionym przez przedstawicieli kościołów. Proponowałbym zapis
      z projektu prof. M. Pietrzaka, prof. A. Rzeplińskiego idra W. Kuleszy w
      brzmieniu: „organy i instytucje państwowe oraz samorządowe . Wersja ta nie
      stwarza niebezpieczeństwa, o którym wspomniał poseł R. Bugaj, mówiąc, że
      nie chciałby zakazu głoszenia przez profesora uniwersytetu swoich poglądów
      filozoficznych. Byłoby to zobowiązanie dotyczące instytucji publicznej, a
      więc uniwersytetu, którego powinnością powinno być zachowanie
      ...
      publiczne i instytucje wykonujące zadania państwa zachowują neutralność w
      sprawach przekonań religijnych i Światopoglądowych”. Rozumiem, że na
      ...
      publiczna, ale nie wykonująca zadań państwa nie miałaby takiej powinności.
      ...
      mnie nie jest to zawę$1enie zakresu autonomii i niezależności kościołów i
      związków wyznaniowych, jeżeli po tym ustępie będzie przepis dotyczący
      współdziałania państwa z koś- ciołami w realizacji praw i potrzeb
      obywateli. Jeżeli mamy dobrą wolę rozwiązania tej kwestii, to nie
      proponujmy niejasnych i nieostrych określeń. Jeżeli już je proponujemy, to
    ...
    <Utterance
      speaker="Poseł Tadeusz Mazowiecki (UW)"
      imgPath="/images/kk-speakers/MazowieckiTadeusz.png"
      text="Odpowiadając na wątpliwości posła R. Bugaja w sprawie wojska Ii np.
      występowania elementów przymusu zwracam uwagę, że dotyczy to władz
      publicznych, władz w wojsku. To one powinny reagować na elementy przymusu,
      jeśli takie występują i do niego nie dopuszczać. Poseł W. Cimoszewicz
      nawoływał przed chwilą do precyzji. Nie bardzo rozumiem, co można uznać za
    ...
    <Utterance
      speaker="Ekspert Komisji, prof. Kazimierz Działocha"
      imgPath="/images/kk-speakers/DzialochaKazimierz.png"
      text="Propozycja posła W. Cimoszewicza, żeby posłużyć się określeniem
      „instytucje wykonujące zadania państwa” wzbudziła zastrzeżenia posła T.
      Mazowieckiego. Jako prawnik, nie tylko teoretyk, ale jako ten, który przez
      wiele lat parał się praktyką prawniczą chciałbym powiedzieć, że pojęcie
      „instytucji wykonujących zadania państwa” lub dodatkowe określenie
      „zadania zlecone przez państwo” czy „funkcje państwa zlecone” jest
      pojęciem ustawowym, doktrynalnym, znanym w naszym orzecznictwie sądowym, w
      tym w orzecznictwie Trybunału Konstytucyjnego. Oznacza to takie twory,
      które nie są częścią aparatu państwowego, np. różnego rodzaju organizacje
      Społeczne, którym państwo w drodze ustawy zleca pewne zadania, zazwyczaj
      ze swej natury należące do zadań państwa. Instytucje i organizacje
      wykonujące zlecone zadania posługują się formami prawnymi
      charakterystycznymi dla władzy państwowej. To są np. samorządy zawodowe,
      różne organizacje kombatanckie zastępujące państwo przy przyznawaniu lub
      stwierdzeniu uprawnień do Świadczeń wynikających z ustawy kombatanckiej.
      Nie można tego mylić z takimi tworami jak uniwersytet. Tu, że jakaś
      jednostka organizacyjna została ustanowiona przez państwo I jest przez nie
      finansowana nie oznacza jeszcze, że jest to instytucja wykonująca zadania
      zlecone przez państwo w takim znaczeniu, jak to się w prawie rozumie. To
      jest pierwsze moje wyjaśnienie w Sprawie terminologii. Pojawił się problem
      władzy w wojsku, gdzie neutralność tych władz powinna być zachowana lub
      widoczna. Posłużę się tekstem art. 35 małej konstytucji, w którym jest
      mowa, że prezydent ma uprawnienia w stosunku do określonych organów.
      Władzą w wojsku czy w stosunku do wojska jako całości jest minister obrony
      narodowej, szef Sztabu Generalnego Wojska Polskiego i jego zastępcy,
      dowódcy rodzajów sił zbrojnych oraz dowódcy okręgów. To są władze
      publiczne, które powinny zachować neutralność. Niepokoi niektórych
      dyskutantów formuła z ust. 3 mówiąca o tym, że kościoły i związki
      wyznaniowe są oddzielone od państwa. Trzeba to interpretować w ten sposób,
    ...
    <Utterance
      speaker="Ekspert Komisji, prof. Piotr Winczorek"
      imgPath="/images/kk-speakers/WinczorekPiotr.png"
      text="Mnie nie razi propozycja wykreślenia z przepisu instytucji
      publicznych, ale mam alternatywny projekt z użyciem tego określenia,
      chociaż — podkreślam — nic złego by się nie stało, gdyby skreślono
    ...
    <Utterance
      speaker="Ekspert Komisji, prof. Kazimierz Działocha"
      imgPath="/images/kk-speakers/DzialochaKazimierz.png"
      text="Przeciwko tej propozycji protestowałbym, dlatego że działanie w
    ...
    <Utterance
      speaker="Poseł Krystyna Łybacka (SLD)"
      imgPath="/images/kk-speakers/LybackaKrystyna.png"
      text="Jeżeli mielibyśmy rozstrzygać, to chciałabym usłyszeć odpowiedź na
    ...
    <Utterance
      speaker="Poseł Ryszard Bugaj (UP)"
      imgPath="/images/kk-speakers/BugajRyszard.png"
      text="W głosowaniu możemy o wszystkim rozstrzygnąć, ale mieliśmy ambicję
      osiągnięcia konsensu, co jest trochę inną sprawą. Wydaje mi się, że
      jesteśmy bardzo bliscy porozumienia w następujących sprawach. Chodzi mi o
      tekst, który został przedstawiony jako uzgodniony między przedstawicielami
      kościołów. Jesteśmy bliscy konsensu co do podziału ust. 4 na dwa ustępy.
      Brzmiałyby one w sposób następujący: „Sytuację prawną Kościoła
      katolickiego określa ustawa oraz umowa mię- dzynarodowa ze Stolicą
      Apostolską ratyfikowana na podstawie upoważnienia wyrażonego w ustawie”.
      Ustęp drugi: „Sytuację prawną innych kościołów i związków wyznaniowych
      określają ustawy uchwalone po porozumieniu z ich właściwymi
      przedstawicielami”. Gdyby była zgoda, to ust. 4 mógłby być ujęty w postaci
      dwóch ustępów. Odniosłem wrażenie, że byliśmy bliscy porozumienia.
      Przedmiotem sporu był ust. 3, który koresponduje z dotychczasowym
      przepisem. Mamy dwie poten Posiedzenia podkomisji stałych Komisji
      Konstytucyjnej ZN cjalne możliwości. Pierwsza polega na przyjęciu formuły
      sugerowanej przez posła W. Cimoszewicza. Wtedy ust. 3 brzmiałby w sposób
      następujący: ,„Władze publiczne i instytucje wykonujące zadania państwa w
      Rzeczypospolitej Polskiej zachowują neutralność w sprawach przekonań
      religijnych, Światopoglądowych i ideologicznych”. Dotychczasowy ust. 3
      pozostałby bez zmian. Jeżeli zgodzimy się, że istnieje iunctim między ust.
      1 i ust. 3, to proponowałbym następującą formułę: „Władze publiczne w
      Rzeczypospolitej Polskiej zachowują neutralność w sprawach przekonań
      religijnych, światopoglądowych i ideologicznych”. Skreślamy więc z tego
      przepisu instytucje. Ust. 3 proponowałbym w brzmieniu: „Kościoły i związki
    ...
    <Utterance
      speaker="Poseł Tadeusz Mazowiecki (UW)"
      imgPath="/images/kk-speakers/MazowieckiTadeusz.png"
      text="Nie jestem przekonany co do potrzeby dodania instytucji wykonujących
    ...
    <Utterance
      speaker="Poseł Ryszard Bugaj (UP)"
      imgPath="/images/kk-speakers/BugajRyszard.png"
      text="Chcę wyjaśnić, że było to nie w kontekście umniejszania zadań
      kościoła i zamykania go w funkcjach religijnych, tylko w kontekście
      autonomicznego i niezależnego wykonywania swoich zadań religijnych.
      Właśnie w takim kontekście pada określenie „religijnych, a nie w znaczeniu
    ...
    <Utterance
      speaker="Senator Krzysztof Kozłowski (KD)"
      imgPath="/images/kk-speakers/KozlowskiKrzysztof.png"
      text="Zgłaszam wątpliwość. Konstytucja, którą uchwalamy określa w art. l
    ...
    <Utterance
      speaker="Poseł Ryszard Bugaj (UP)"
      imgPath="/images/kk-speakers/BugajRyszard.png"
      text="O ile wiem, to sprawa ta w rozdziale I została inaczej zapisana.
      Proszę o wnioski. Próbuję znaleźć konsens, a jeżeli go nie będzie, to
      trudno. Jeżeli są wnioski, to proszę je zgłosić. Przedstawiciel Kościoła
    ...
    <Utterance
      speaker="Poseł Ryszard Bugaj (UP)"
      imgPath="/images/kk-speakers/BugajRyszard.png"
      text="Na razie jesteśmy bliscy konsensu, jeżeli porozumienie nie zostanie
      ...
      światopoglądowych i ideologicznych. Ust. 2. Kościoły I związki wyznaniowe
      są równouprawnione. Ust. 3. Sytuację prawną Kościoła katolickiego określa
      ustawa oraz umowa międzynarodowa ze Stolicą Apostolską ratyfikowana na
      podstawie upoważnienia wyrażonego w ustawie. Ust. 4. Sytuację prawną
      innych kościołów i związków wyznaniowych określają ustawy uchwalone po
      porozumieniu się z ich właściwymi przedstawicielami. Ust. 5. Kościoły i
      związki wyznaniowe są oddzielone od państwa i autonomiczne oraz niezależne
      w wykonywaniu swoich zadań. Ust. 6. W celu realizacji praw człowieka i
    ...
    <Utterance
      speaker="Poseł Ryszard Bugaj (UP)"
      imgPath="/images/kk-speakers/BugajRyszard.png"
      text="Rozumiem, że jest to zgłoszone w trybie autopoprawki. (22.02.1995 r.
    ...
    <Utterance
      speaker="Poseł Ryszard Bugaj (UP)"
      imgPath="/images/kk-speakers/BugajRyszard.png"
      text="W stosunku do pierwotnego zapisu zmieniłem tylko jeden element.
    ...
    <Utterance
      speaker="Poseł Ryszard Bugaj (UP)"
      imgPath="/images/kk-speakers/BugajRyszard.png"
      text="Rozumiem, że zastrzeżenie księdza profesora dotyczy tylko formuły:
      „I instytucje wykonujące zadania państwa”. Przedstawiciel Sekretariatu
    ...
    <Utterance
      speaker="Poseł Ryszard Bugaj (UP)"
      imgPath="/images/kk-speakers/BugajRyszard.png"
      text="Jestem w trudnej sytuacji. O godz. 11 wiele osób mówiło, że
      niesłychanie pożądane byłoby osiągnięcie w tej sprawie konsensu w
      podkomisji. Głównie mówił o tym poseł J. Jaskiernia. Nie mając do tego
      stosunku merytorycznego, przyjąłem to zadanie, które próbuję realizować,
      ponieważ wydawało mi się, że Komisja Konstytucyjna tego od nas oczekuje.
    ...
    <Utterance
      speaker="Poseł Krystyna Łybacka (SLD)"
      imgPath="/images/kk-speakers/LybackaKrystyna.png"
      text="Składam wniosek formalny, aby przejść do fazy głosowania w momencie
    ...
    <Utterance
      speaker="Poseł Ryszard Bugaj (UP)"
      imgPath="/images/kk-speakers/BugajRyszard.png"
      text="Sądzę, że sprawa nie jest całkowicie przegrana, ale jeśli pani poseł
      pozwoli, to za chwileczkę się przekonamy, po wyjaśnieniu poprawki
      przedstawionej przed chwilą przez senatora K. Kozłowskiego. Będziemy mogli
      ocenić, czy w tej sprawie jesteśmy zgodni, czy nie. Rozumiem, że jest
      uwaga krytyczna ze strony przedstawiciela Kościoła katolickiego, która
      została przedłożona jako autopoprawka do sformułowania: „i instytucje
      wykonujące zadania państwa”. Ta uwaga jest dyskusyjna i zobaczymy, czy w
      gronie człon Posiedzenia podkomisji stałych Komisji Konstytucyjnej ZN ków
      podkomisji ten sprzeciw się potwierdzi. Jeśli tak, to pozostanie nam tylko
      rozstrzygnięcie w trybie głosowania, co zresztą będzie mało realne, bo
    ...
    <Utterance
      speaker="Poseł Włodzimierz Cimoszewicz (SLD)"
      imgPath="/images/kk-speakers/CimoszewiczWlodzimierz.png"
      text="Apeluję do przewodniczącego, żeby się nie poddawał. Wariant
      ...
      odzwierciedlenie m.in. w ustawach ustalających sytuację prawną. Dlatego ta
      formuła powinna poprzedzać przepis mówiący o sytuacji prawnej I nie należy
      tego zmieniać. Już wcześniej powiedzieliśmy sobie, że z istotnych względów
      warto ust. 5 przesunąć na czwartą pozycję, bo on dopełnia formułę
      oddzielenia, autonomii, niezależności i współpracy, rozumianą jako zasadę
      konstruującą relacje między kościołem i państwem. Dopiero na tym tle
      powstają inne regulacje prawne ustawowe lub umowne. Ostatnia uwaga.
      Większość osób, jeśli nie wszystkie, akceptuje ideę dwóch ustępów
      odnoszących się do prawnych źródeł regulacji sytuacji kościołów i wyznań,
      co nie oznacza, że wszyscy mają identyczny pogląd na treść tych ustępów. W
      moim przekonaniu najpierw powinien być ustęp odnoszący się do wszystkich
      kościołów i wyznań, a więc konstruujący zasadę ogólną. Chodziłoby o to, że
      sytuację prawną kościołów określają ustawy uchwalone po porozumieniu.
      Dopiero sytuacją szczególną, bo dotyczącą jednego kościoła jest umowa
      międzynarodowa, która powinna być umieszczona w drugim zdaniu tego samego
      ustępu, żeby pokazać łączność tego zagadnienia. Różnimy się między sobą w
    ...
    <Utterance
      speaker="Poseł Ryszard Bugaj (UP)"
      imgPath="/images/kk-speakers/BugajRyszard.png"
      text="Nie poddawałem się w poszukiwaniu konsensu aż do momentu tej
      wypowiedzi. Jeśli sprawa kolejności zdań jest tak zasadnicza, że jej nie
      możemy przesądzić, to z pewnością sobie nie poradzimy. Formuła, że
      sytuację prawną Kościoła katolickiego określają ustawy oraz umowa
      międzynarodowa, dopuszcza ewentualność nieuregulowania tych stosunków
      umową międzynarodową. Wówczas będą to regulowały ustawy i nie ma przymusu
      w tym przypadku. Gdyby użyty był zwrot: „tylko umowa międzynarodowa”, to
      taki przymus byłby implikowany. Były różne prawne interpretacje. Wydaje mi
      się, że istnieje możliwość zachowania formuły „oraz ”, która nie zburzy
      całej konstrukcji. Gdyby było inaczej, to byłbym otwarty na argumenty.
    ...
    <Utterance
      speaker="Ekspert Komisji, prof. Piotr Winczorek"
      imgPath="/images/kk-speakers/WinczorekPiotr.png"
      text="Muszę powiedzieć, że nie podoba mi się formuła „władze państwowe”,
      czy „organy państwowe”. Przepis w wynegocjowanym ujęciu rozumiem w ten
      ...
      władzy publicznej, czy organy władzy państwowej. Chodzi chyba także o ich
      działalność, ale na pewno nie o państwo rozumiane w socjologicznym ujęciu,
      jako wspólnota obywatelska. Od tego związki wyznaniowe oddzielone być nie
      mogą. Gdyby do tego przepisu wprowadzić władze publiczne czy władze
      państwowe zamiast państwa, to stworzy się dziwna nierównowaga. Nie
    ...
    <Utterance
      speaker="Poseł Ryszard Bugaj (UP)"
      imgPath="/images/kk-speakers/BugajRyszard.png"
      text="Czy ta formuła jest zachęcająca dla senatora K. Kozłowskiego” Jest
      pan właścicielem wniosku, więc jaka jest pańska konkluzja? Jeśli
    ...
    <Utterance
      speaker="Poseł Ryszard Bugaj (UP)"
      imgPath="/images/kk-speakers/BugajRyszard.png"
      text="Panie pośle, pytam jeszcze raz: czy jest konsens w stosunku do
      tekstu sześcioustępowego? Możemy jeszcze zastanowić się nad kolejnością
      tych ustępów. Ponownie czytam tekst. „Ust. 1. Władze publiczne i
      instytucje wykonujące zadania państwa w Rzeczypospolitej Polskiej
      zachowują neutralność w sprawach przekonań religijnych, Światopoglądowych
      1 ideologicznych. Ust. 2. Kościoły I związki wyznaniowe są
    ...
    <Utterance
      speaker="Poseł Włodzimierz Cimoszewicz (SLD)"
      imgPath="/images/kk-speakers/CimoszewiczWlodzimierz.png"
      text="Poza pewnymi sprawami, które zarysowały się jako spome, pojawiają
      się nowe sformułowania. Nie wiem, czy są one przypadkowe. Czy uwagi do
    ...
    <Utterance
      speaker="Poseł Ryszard Bugaj (UP)"
      imgPath="/images/kk-speakers/BugajRyszard.png"
      text="Jest to pytanie skierowane do przedstawicieli kościołów. Obawiam
      się, że odpowiedź na to pytanie nie może paść tak szybko. Poseł
      Włodzimierz Cimoszewicz (SLD): Ktoś jest autorem rozpatrywanej propozycji.
    ...
    <Utterance
      speaker="Poseł Ryszard Bugaj (UP)"
      imgPath="/images/kk-speakers/BugajRyszard.png"
      text="Moim niefachowym umysłem rozumiem, że trzeba to czytać w kontekście
    ...
    <Utterance
      speaker="Poseł Krystyna Łybacka (SLD)"
      imgPath="/images/kk-speakers/LybackaKrystyna.png"
      text="Mam również pytanie do wnioskodawców tekstu, który rzekomo jest
      tekstem uzgodnionym z przedstawicielami kościołów. Jeżeli tak bardzo
    ...
    <Utterance
      speaker="Poseł Ryszard Bugaj (UP)"
      imgPath="/images/kk-speakers/BugajRyszard.png"
      text="Oczywiście, że są pewne zadania społeczne. W tej sprawie mamy
      pewność, bo zadań społecznych nigdy nie kwestionowaliśmy, jak myślę.
      Osobiście miałem nadzieję, że niektóre zadania społeczne, charytatywne
      itp. będą pełnione szerzej. Przedstawiciel Sekretariatu Konferencji
      Episkopatu Polski, ks. prof. Józef Krukowski: Niewątpliwie zadania
      wynikają z natury tych społeczności. Uważam, że całkowicie prawdziwa jest
      opinia posła R. Bugaja, iż zadania te będą dokładnie sprecyzowane w
      ustawach i umowach, czyli w źródłach prawa. Ustawa o stosunku państwa do
    ...
    <Utterance
      speaker="Poseł Ryszard Bugaj (UP)"
      imgPath="/images/kk-speakers/BugajRyszard.png"
      text="Jeżeli ktoś bardzo chciałby zabrać głos, to go udzielę, ale teraz po
      raz ostatni chciałbym zapytać, czy mam prawo na plenarnym posiedzeniu
    ...
    <Utterance
      speaker="Poseł Krystyna Łybacka (SLD)"
      imgPath="/images/kk-speakers/LybackaKrystyna.png"
      text="Zastrzeżenia są do trzech kwestii. Zastrzeżenie pierwsze dotyczy
    ...
    <Utterance
      speaker="Poseł Włodzimierz Cimoszewicz (SLD)"
      imgPath="/images/kk-speakers/CimoszewiczWlodzimierz.png"
      text="Chciałbym zaproponować rozwiązanie, które może być przyjęte przez
      ...
      precyzowana przez określenie zadań, których dotyczy, czy ma się oprzeć na
    ...
    <Utterance
      speaker="Poseł Ryszard Bugaj (UP)"
      imgPath="/images/kk-speakers/BugajRyszard.png"
      text="Taki jest walor konsensu, że obejmuje on wszystkie elementy, nawet
      jeśli niektóre z nich nie są w sposób oczywisty doprecyzowane. Myślę, że z
      konsensem jest tak, jak z innymi rzeczami — albo on jest, albo go nie ma.
    ...
    <Utterance
      speaker="Poseł Tadeusz Mazowiecki (UW)"
      imgPath="/images/kk-speakers/MazowieckiTadeusz.png"
      text="Zgadzam się z panem przewodniczącym, że albo konsens jest, al
      Podkomisja podstaw ustroju politycznego... (22.02.1995 r. —- 14) 103 bo go
      nie ma. Państwo chcecie ten problem przenieść na ogólne zebranie Komisji,
      gdzie macie większość. Proszę bardzo. My to będziemy przenosić na
      referendum. Przed chwilą poseł K. Łybacka — która zabierała głos co
      chwila, ja czekałem cierpliwie — mówiła, że nie można tego uzgodnić.
      Proszę więc, przegłosujcie to państwo. Wykazaliśmy maksimum dobrej woli,
