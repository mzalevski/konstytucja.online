    ...
    <div
      ...
      <form class="mt-4" name="feedbackForm" method="POST" data-netlify="true">
        <div class="relative inline-block w-full">
          ...
          <select
            name="topic"
            class="w-full px-8 py-1 font-light text-gray-900 bg-white border border-gray-100 rounded-md shadow-sm appearance-none cursor-pointer">
        ...
        <div class="flex justify-around mt-4">
          <button
            ...
            class="w-full px-4 py-2 mr-2 shadow">
            Annuluj
          </button>
          <button type="submit" class="w-full px-4 py-2 ml-2 shadow">
            Wyślij
          </button>
        </div>
      </form>
