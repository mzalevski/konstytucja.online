    ...
    >
      ...
      {#if showDropdown}
        <div
          ...
          class="fixed top-0 left-0 z-10 flex flex-col w-screen h-screen pt-16 mt-px space-y-px text-center bg-white border border-gray-200 rounded shadow-lg cursor-default sm:absolute sm:left-auto sm:top-auto sm:pt-0 sm:text-left sm:p-2 sm:w-48 sm:h-auto"
        >
